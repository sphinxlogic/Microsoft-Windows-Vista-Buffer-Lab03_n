    ...
    public abstract class GenericAce 
    {
        ...
        internal void MarshalHeader( byte[] binaryForm, int offset )
        {
            ...
            { 
                ...
                BCLDebug.Assert( false, "Length > ushort.MaxValue" ); 
    ...
    public sealed class CustomAce : GenericAce 
    {
        ...
        { 
            ...
            if ( OpaqueLength != 0 ) 
            {
                ...
                {
                    BCLDebug.Assert( false, "OpaqueLength somehow managed to exceed MaxOpaqueLength" ); 
                    throw new SystemException();
                } 
        ...
        { 
            ...
            { 
                ...
                default: 
                    ...
                    BCLDebug.Assert( false, "Invalid ACE type" );
                    throw new SystemException(); 
            }
        } 
