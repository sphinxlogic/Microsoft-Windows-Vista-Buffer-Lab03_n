...
/* SSS_WARNINGS_OFF */                        // Special case for Taiwan calendar. 
                        // 0x0404 is the locale ID for Taiwan. 
/* SSS_WARNINGS_ON */                        m_eraNames = new String[] {CalendarTable.nativeGetEraName(0x0404, Calendar.ID)};
                    } 
                }
                return (m_eraNames);
            }
            ...
            get { 
                if (m_abbrevEraNames == null) {
                    if (Calendar.ID == Calendar.CAL_TAIWAN) { 
                        ...
                        if (twnEra.Length > 0) {
                            if (twnEra.Length == 4) { 
/* SSS_WARNINGS_OFF */                                // Windows 2000 & above use 4-character era name.
                                // Special case for Taiwan because of geo-political issue.
/* SSS_WARNINGS_ON */                                m_abbrevEraNames = new String[] {twnEra.Substring(2, 2)};
                            } else { 
...
/* SSS_WARNINGS_OFF */
                if (Calendar.ID == Calendar.CAL_TAIWAN) {
                    //
                    // Special case for Taiwan calenadr. 
                    //
...
/* SSS_WARNINGS_OFF */                    DateTimeFormatInfo twDtfi = GetTaiwanCalendarDTFI(); /* SSS_WARNINGS_ON */
