    ...
    sealed internal class SqlInternalConnectionSmi : SqlInternalConnection { 
        ...
        sealed private class EventSink : SmiEventSink_Default {
            ...
            override protected void DispatchMessages(bool ignoreNonFatalMessages) { 
                ...
                if (null != exception) {
                    if (_connection.Connection.FireInfoMessageEventOnUserErrors) { 
                        _connection.Connection.OnInfoMessage(new SqlInfoMessageEventArgs(exception)); 
                    }
                    else { 
            ...
            internal override void TransactionEnded( long transactionId ) {
                ...
                _connection.TransactionEndedByServer(transactionId); 
            }
            ...
            internal override void TransactionRolledBack( long transactionId ) {
                ...
                _connection.TransactionEnded(transactionId, TransactionState.Aborted);
            } 
        ...
        override internal void AddPreparedCommand(SqlCommand cmd) { 
            // this is currently a NOOP in the Smi case, as there is no real use
        ...
        override protected void InternalDeactivate() { 
            ...
            // or any activity (commit/rollback) may cause it to hang.
        ...
        override internal void ExecuteTransaction(TransactionRequest transactionRequest, string transactionName, IsolationLevel iso, SqlInternalTransaction internalTransaction, bool isDelegateControlRequest) { 
            if (Bid.AdvancedOn) {
        ...
        private void TransactionEndedByServer(long transactionId) { 
            ...
            // 
            TransactionEnded(transactionId, TransactionState.Unknown);
        }
