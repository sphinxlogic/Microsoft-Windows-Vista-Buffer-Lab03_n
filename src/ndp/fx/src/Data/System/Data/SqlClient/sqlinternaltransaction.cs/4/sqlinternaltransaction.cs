    ...
    sealed internal class SqlInternalTransaction { 
        ...
        internal void CloseFromConnection() { 
            ...
            try {
                ...
                Debug.Assert(null != Thread.GetData(TdsParser.ReliabilitySlot), "unreliable call to CloseFromConnection");  // you need to setup for a thread abort somewhere before you call this method 
