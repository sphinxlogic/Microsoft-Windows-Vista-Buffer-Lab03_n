...
namespace System.Data { 
    ...
    internal static class ExceptionBuilder {
        ...
        static private DataException _Data(string error, Exception innerException) {
        ...
        static public DataException ConvertFailed(Type type1, Type type2) {
            return ConvertFailed(type1, type2, (Exception)null); 
        }
 
        static public DataException ConvertFailed(Type type1, Type type2, Exception innerExeption) { 
            return _Data(Res.GetString(Res.SqlConvert_ConvertFailed, type1.FullName, type2.FullName), innerExeption);
        } 
