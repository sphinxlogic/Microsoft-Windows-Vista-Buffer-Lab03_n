...
//                            dt.SelfNestedWithOneRelation) { // this is wrong bug it was previous behavior
        ...
        {
            IntPtr hscp; 
            Bid.ScopeEnter(out hscp, "<ds.DataSet.WriteXmlSchema|API> %d#\n", ObjectID);
            try { 
...
//            return GetSchemaSerializable(); 
        ...
        void IXmlSerializable.WriteXml(XmlWriter writer) { 
            WriteXmlSchema(writer, SchemaFormat.WebService);
    ...
    public 
#endif
    class DataSetSchemaImporterExtension : SchemaImporterExtension {
