    ...
    public sealed class SqlCacheDependency : CacheDependency { 
        ...
        internal static CacheDependency CreateOutputCacheDependency(string depString) {
            ...
            if (StringUtil.EqualsIgnoreCase(depString, SQL9_CACHE_DEPENDENCY_DIRECTIVE)) {
                ...
                sqlDependencies = ParseSql7OutputCacheDependency(depString); 
                ...
                if (sqlDependencies.Count == 1) { 
                    ...
                    return CreateSql7SqlCacheDependencyForOutputCache(info._database, info._table, depString); 
                } 
                ...
                for(int i=0; i < sqlDependencies.Count; i++) {
                    ...
                    aggr.Add(CreateSql7SqlCacheDependencyForOutputCache(info._database, info._table, depString)); 
                }
