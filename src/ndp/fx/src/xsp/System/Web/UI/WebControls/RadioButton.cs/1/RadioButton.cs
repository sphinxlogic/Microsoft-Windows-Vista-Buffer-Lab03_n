...
namespace System.Web.UI.WebControls { 
    ...
    public class RadioButton : CheckBox, IPostBackDataHandler {
...
#if SHIPPINGADAPTERS
        internal static readonly string AltSelectedText = "(o)"; 
        internal static readonly string AltUnselectedText = "(_)";
#endif 
        ...
        internal override void RenderInputTag(HtmlTextWriter writer, string clientID, string onClick) {
            ...
            // ASURT 119141: Render Disabled attribute on the INPUT tag (instead of the SPAN) so the checkbox actually gets disabled when Enabled=false
            if (!IsEnabled) { 
