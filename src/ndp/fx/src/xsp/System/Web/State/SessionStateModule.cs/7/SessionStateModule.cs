...
namespace System.Web.SessionState { 
    ...
    public sealed class SessionStateModule : IHttpModule { 
        ...
        SessionStateStoreProviderBase InitCustomStore(SessionStateSection config) {
            ...
            return (SessionStateStoreProviderBase)ProvidersHelper.InstantiateProvider(ps, typeof(SessionStateStoreProviderBase)); 
        }
        ...
        void RaiseOnStart(EventArgs e) {
            ...
            if (HttpRuntime.ApartmentThreading || _rqContext.InAspCompatMode) {
                ...
                if (HttpContext.Current == null) {
                    ...
                    HttpContextWrapper.SwitchContext(_rqContext); 
                }
        ...
        void PollLockedSessionCallback(object state) { 
            ...
            try { 
                ...
                if (    (timerId == _timerId) && 
                    ...
                    if (isCompleted) { 
                        // Have to call this here because RestoreImpersonation() has to be called first, as 
                        // _rqAr.Complete will eventually call OnEndRequest, which will call
                        // ResetPerRequestFields, which will clear out all fields, including the 
