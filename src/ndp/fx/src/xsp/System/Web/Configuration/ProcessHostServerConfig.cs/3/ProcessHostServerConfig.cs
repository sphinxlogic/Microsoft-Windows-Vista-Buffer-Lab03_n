...
namespace System.Web.Configuration { 
    ...
    internal sealed class ProcessHostServerConfig : IServerConfig { 
        ...
        string[] IServerConfig.GetVirtualSubdirs(VirtualPath path, bool inApp) {
            ...
            try {
                int count = 0; 
                int result = UnsafeIISMethods.MgdGetAppCollection(_siteNameForCurrentApplication, vpath, out pBstr, out cBstr, out pAppCollection, out count); 
        ...
        internal bool IsWithinApp(string virtualPath) {
            return UnsafeIISMethods.MgdIsWithinApp(_siteNameForCurrentApplication, HttpRuntime.AppDomainAppVirtualPathString, virtualPath); 
        }
        ...
        bool IServerConfig.GetUncUser(IApplicationHost appHost, VirtualPath path, out string username, out string password) { 
            ...
            try {
                int result = UnsafeIISMethods.MgdGetVrPathCreds( appHost.GetSiteName(), 
