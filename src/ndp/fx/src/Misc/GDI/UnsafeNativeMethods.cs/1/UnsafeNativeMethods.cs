...
#endif 
{
    ...
    { 
        ...
        public static bool DeleteDC(HandleRef hDC) { 
            ...
            DbgUtil.AssertWin32(retVal, "DeleteDC([hdc=0x{0:X8}]) failed.", (int)hDC.Handle); 
            return retVal;
        } 
        public static bool DeleteHDC(HandleRef hDC) {
            ...
            bool retVal = IntDeleteDC(hDC);
            DbgUtil.AssertWin32(retVal, "DeleteHDC([hdc=0x{0:X8}]) failed.", (int)hDC.Handle); 
            return retVal;
        } 
        ...
        public static IntPtr CreateDC(String lpszDriverName, string lpszDeviceName, string lpszOutput, HandleRef /*DEVMODE*/ lpInitData)
        {
            ...
            DbgUtil.AssertWin32(hdc != IntPtr.Zero, "CreateDC([driverName={0}], [deviceName={1}], [fileName={2}], [devMode={3}]) failed.", lpszDriverName, lpszDeviceName, lpszOutput, (int)lpInitData.Handle );
            return hdc; 
        } 
        ...
        public static IntPtr CreateIC(string lpszDriverName, string lpszDeviceName, string lpszOutput, HandleRef /*DEVMODE*/ lpInitData) 
        {
            ...
            DbgUtil.AssertWin32(hdc != IntPtr.Zero, "CreateIC([driverName={0}], [deviceName={1}], [fileName={2}], [devMode={3}]) failed.", lpszDriverName, lpszDeviceName, lpszOutput, (int)lpInitData.Handle ); 
            return hdc;
        } 
        ...
        { 
            ...
            DbgUtil.AssertWin32(compatibleDc != IntPtr.Zero, "CreateCompatibleDC([hdc=0x{0:X8}]) failed", (int)hDC.Handle);
            return compatibleDc;
        } 
        ...
        public static int SaveDC(HandleRef hDC) 
        {
            ...
            DbgUtil.AssertWin32(state != 0, "SaveDC([hdc=0x{0:X8}]) failed", (int)hDC.Handle);
            return state; 
        }
        ...
        public static bool OffsetViewportOrgEx(HandleRef hDC, int nXOffset, int nYOffset, [In, Out] IntNativeMethods.POINT point) 
        {
            ...
            DbgUtil.AssertWin32(retVal, "OffsetViewportOrgEx([hdc=0x{0:X8}], dx=[{1}], dy=[{2}], [out pPoint]) failed.", (int)hDC.Handle, nXOffset, nYOffset);
            return retVal; 
        }
        ...
        public static int SetGraphicsMode(HandleRef hDC, int iMode) 
        {
            ...
            DbgUtil.AssertWin32(iMode != 0, "SetGraphicsMode([hdc=0x{0:X8}], [GM_ADVANCED]) failed.", (int)hDC.Handle);
            return iMode; 
        }
        ...
        public static int GetClipRgn(HandleRef hDC, HandleRef hRgn) {
            ...
            DbgUtil.AssertWin32(retVal != -1, "IntGetClipRgn([hdc=0x{0:X8}], [hRgn]) failed.", (int)hDC.Handle);
            return retVal;
        }
        ...
        public static IntNativeMethods.RegionFlags SelectClipRgn(HandleRef hDC, HandleRef hRgn) 
        {
            ...
            DbgUtil.AssertWin32(result != IntNativeMethods.RegionFlags.ERROR, "SelectClipRgn([hdc=0x{0:X8}], [hRegion=0x{1:X8}]) failed.", (int)hDC.Handle, (int)hRgn.Handle);
            return result;
        }
        ...
        public static IntNativeMethods.RegionFlags GetRgnBox(HandleRef hRgn, [In, Out] ref IntNativeMethods.RECT clipRect) 
        {
            ...
            DbgUtil.AssertWin32(result != IntNativeMethods.RegionFlags.ERROR, "GetRgnBox([hRegion=0x{0:X8}], [out rect]) failed.", (int)hRgn.Handle);
            return result;
        }
        ...
        public static bool DeleteObject(HandleRef hObject)
        {
            ...
            DbgUtil.AssertWin32(retVal, "DeleteObject(hObj=[0x{0:X8}]) failed.", (int) hObject.Handle); 
            return retVal; 
        }
        ...
        { 
            ...
            DbgUtil.AssertWin32(retVal != 0, "GetObject(hObj=[0x{0:X8}], [LOGBRUSH]) failed.", (int) hBrush.Handle ); 
            return retVal; 
        }
        ...
        public static int GetObject(HandleRef hFont, IntNativeMethods.LOGFONT lp) 
        {
            ...
            DbgUtil.AssertWin32(retVal != 0, "GetObject(hObj=[0x{0:X8}], [LOGFONT]) failed.", (int) hFont.Handle ); 
            return retVal;
        } 
        ...
        public static IntPtr SelectObject(HandleRef hdc, HandleRef obj) 
        {
            ...
            DbgUtil.AssertWin32(oldObj != IntPtr.Zero, "SelectObject(hdc=hObj=[0x{0:X8}], hObj=[0x{1:X8}]) failed.", (int) hdc.Handle, (int) obj.Handle ); 
            return oldObj;
        } 
        ...
        { 
            ...
            DbgUtil.AssertWin32(oldMode != 0, "SetBkMode(hdc=[0x{0:X8}], Mode=[{1}]) failed.", (int)hDC.Handle, nBkMode );
            return oldMode; 
        }
        ...
        { 
            ...
            DbgUtil.AssertWin32(mode != 0, "GetBkMode(hdc=[0x{0:X8}]) failed.", (int)hDC.Handle );
            return mode; 
        }
        ...
        public static int DrawText( HandleRef hDC, string text, ref IntNativeMethods.RECT lpRect, int nFormat ) 
        {
            ...
            if( Marshal.SystemDefaultCharSize == 1 ) 
            {
                ...
                // it fails and return negative values as the rect in which it painted the text
            ...
            DbgUtil.AssertWin32( retVal != 0, "DrawText(hdc=[0x{0:X8}], text=[{1}], rect=[{2}], flags=[{3}] failed.", (int) hDC.Handle, text, lpRect, nFormat ); 
            return retVal;
        } 
        ...
        { 
            ...
            DbgUtil.AssertWin32(retVal != 0, "DrawTextEx(hdc=[0x{0:X8}], text=[{1}], rect=[{2}], flags=[{3}] failed.", (int)hDC.Handle, text, lpRect, nFormat );
            return retVal; 
        } 
        ...
        { 
            ...
            DbgUtil.AssertWin32(retVal != 0, "GetTextExtentPoint32(hdc=[0x{0:X8}], text=[{1}], size=[{2}] failed.", (int)hDC.Handle, text, size );
            return retVal;
        } 
        ...
        { 
            ...
            DbgUtil.AssertWin32(retVal, "LineTo(hdc=[0x{0:X8}], x=[{1}], y=[{2}] failed.", (int) hdc.Handle, x, y ); 
            return retVal;
        }
        ...
        { 
            ...
            DbgUtil.AssertWin32(retVal, "MoveToEx(hdc=[0x{0:X8}], x=[{1}], y=[{2}], pt=[{3}] failed.", (int) hdc.Handle, x, y, pt ); 
            return retVal;
        }
        ...
        { 
            ...
            DbgUtil.AssertWin32(retVal, "Rectangle(hdc=[0x{0:X8}], left=[{1}], top=[{2}], right=[{3}], bottom=[{4}] failed.", (int) hdc.Handle, left, top, right, bottom ); 
            return retVal;
        }
        ...
        { 
            ...
            DbgUtil.AssertWin32(retVal, "FillRect(hdc=[0x{0:X8}], rect=[{1}], hbrush=[{2}]", (int)hDC.Handle, rect, hbrush.Handle); 
            return retVal;
        }
        ...
        { 
            ...
            DbgUtil.AssertWin32(oldMapMode != 0, "SetMapMode(hdc=[0x{0:X8}], MapMode=[{1}]", (int)hDC.Handle, nMapMode); 
            return oldMapMode;
        }
        ...
        { 
            ...
            DbgUtil.AssertWin32(mapMode != 0, "GetMapMode(hdc=[0x{0:X8}]", (int)hDC.Handle); 
            return mapMode;
        }
        ...
        { 
            ...
            DbgUtil.AssertWin32(retVal, "GetViewportExtEx([hdc=0x{0:X8}], [out size]) failed.", (int)hdc.Handle); 
            return retVal;
        }
        ...
        { 
            ...
            DbgUtil.AssertWin32(retVal, "GetViewportOrgEx([hdc=0x{0:X8}], [out point]) failed.", (int)hdc.Handle); 
            return retVal;
        }
        ...
        { 
            ...
            DbgUtil.AssertWin32(retVal, "SetViewportExtEx([hdc=0x{0:X8}], x=[{1}], y=[{2}], [out size]) failed.", (int)hDC.Handle, x, y); 
            return retVal;
        }
        ...
        { 
            ...
            DbgUtil.AssertWin32(retVal, "SetViewportOrgEx([hdc=0x{0:X8}], x=[{1}], y=[{2}], [out point]) failed.", (int)hDC.Handle, x, y);
            return retVal; 
        }
        ...
        public static int GetTextMetrics(HandleRef hDC, ref IntNativeMethods.TEXTMETRIC lptm)
        {
            ...
            DbgUtil.AssertWin32(retVal != 0, "GetTextMetrics(hdc=[0x{0:X8}], [out TEXTMETRIC] failed.", (int)hDC.Handle );
            return retVal; 
        }
        ...
        public static bool BeginPath(HandleRef hDC) 
        {
            ...
            DbgUtil.AssertWin32(retVal, "BeginPath(hdc=[0x{0:X8}]failed.", (int)hDC.Handle );
            return retVal; 
        }
        ...
        public static bool EndPath(HandleRef hDC) 
        {
            ...
            DbgUtil.AssertWin32(retVal, "EndPath(hdc=[0x{0:X8}]failed.", (int)hDC.Handle );
            return retVal; 
        }
        ...
        public static bool StrokePath(HandleRef hDC) 
        {
            ...
            DbgUtil.AssertWin32(retVal, "StrokePath(hdc=[0x{0:X8}]failed.", (int)hDC.Handle );
            return retVal; 
        }
        ...
        public static bool AngleArc(HandleRef hDC, int x, int y, int radius, float startAngle, float endAngle) 
        {
            ...
            DbgUtil.AssertWin32(retVal, "AngleArc(hdc=[0x{0:X8}], ...) failed.", (int)hDC.Handle);
            return retVal; 
        }
            ...
            )
        {
            ...
            DbgUtil.AssertWin32(retVal, "Arc(hdc=[0x{0:X8}], ...) failed.", (int)hDC.Handle);
            return retVal; 
        } 
        ...
        public static bool Ellipse(HandleRef hDc, int x1, int y1, int x2, int y2) 
        {
            ...
            DbgUtil.AssertWin32(retVal, "Ellipse(hdc=[0x{0:X8}], x1=[{1}], y1=[{2}], x2=[{3}], y2=[{4}]) failed.", (int) hDc.Handle, x1, y1, x2, y2);
            return retVal;
        }
