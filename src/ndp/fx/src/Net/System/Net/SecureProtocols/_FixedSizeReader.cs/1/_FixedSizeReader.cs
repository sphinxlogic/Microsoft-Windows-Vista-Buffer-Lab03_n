...
namespace System.Net {
    ...
    internal class FixedSizeReader {
        ...
        private static void ReadCallback(IAsyncResult transportResult) 
        {
            ...
            {
                if (reader._Request.IsUserCompleted)
                    throw; 
                reader._Request.CompleteWithError(e);
            } 
            catch { 
                if (reader._Request.IsUserCompleted)
                    throw; 
                reader._Request.CompleteWithError(new Exception(SR.GetString(SR.net_nonClsCompliantException)));
            }
        }
    } 
