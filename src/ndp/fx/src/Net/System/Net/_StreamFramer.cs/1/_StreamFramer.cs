        ...
        */
        ...
        private void ReadFrameCallback(IAsyncResult transportResult) 
        {
            ...
            try
            {
                ...
                Exception e1 = new System.IO.IOException(SR.GetString(SR.net_io_readfailure, string.Empty), new Exception(SR.GetString(SR.net_nonClsCompliantException))); 

                // Let's call user callback and he call us back and we will throw
                workerResult.InvokeCallback(e1);
            } 
        }
        ...
        private void BeginWriteCallback(IAsyncResult transportResult) {
            ...
            catch (Exception e) 
            {
                ...
                workerResult.InvokeCallback(new Exception(SR.GetString(SR.net_nonClsCompliantException)));
            } 
        }
