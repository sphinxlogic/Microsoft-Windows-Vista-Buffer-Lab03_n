...
//
        ...
        // 
        // SchemaAttDefToNodeDataComparer
        //
        private class SchemaAttDefToNodeDataComparer : IComparer {
            ...
            public int Compare(object x, object y) {
                Debug.Assert(x == null || x is NodeData || x is SchemaAttDef);
                Debug.Assert(y == null || y is NodeData || y is SchemaAttDef); 
                ...
                if (nodeData != null) {
                    ...
                    SchemaAttDef attrDef = x as SchemaAttDef; 
                    if (attrDef != null) {
                        localName = attrDef.Name.Name; 
                ...
                if (nodeData != null) { 
                    ...
                    SchemaAttDef attrDef = y as SchemaAttDef;
                    if (attrDef != null) {
                        localName2 = attrDef.Name.Name; 
