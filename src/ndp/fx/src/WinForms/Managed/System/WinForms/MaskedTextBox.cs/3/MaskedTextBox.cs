...
{ 
    ...
    public class MaskedTextBox : TextBoxBase
    {
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            ...
            { 
                ...
                { 
                    ...
                    if ((Control.ImeModeConversion.InputLanguageTable == Control.ImeModeConversion.KoreanTable) && this.flagState[IME_ENDING_COMPOSITION])
                    { 
        ...
        { 
            ...
            { 
                if (selectionLen > 0  && (Control.ImeModeConversion.InputLanguageTable == Control.ImeModeConversion.KoreanTable))
                {
