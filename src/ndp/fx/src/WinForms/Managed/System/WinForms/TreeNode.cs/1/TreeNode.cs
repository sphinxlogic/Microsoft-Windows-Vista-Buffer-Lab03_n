    ...
    public class TreeNode : MarshalByRefObject, ICloneable, ISerializable { 
       ...
       [Browsable(false)] 
        ...
        internal void Realize(bool insertFirst) { 
            ...
            if (parent == null && !tv.IsUpdating() && Application.RenderWithVisualStyles) {
                tv.SendMessage(NativeMethods.WM_SETREDRAW, 0, 0);
            }
            ...
            try {
                ...
                if (!tv.IsUpdating() && parent == null && Application.RenderWithVisualStyles) { 
                    tv.SendMessage(NativeMethods.WM_SETREDRAW, -1, 0);
                } 
            } 
        ...
        internal void Remove(bool notify) { 
            ...
            if (notify && parent != null) { 
                // the for loop below will always skip the indexed node if index == parent.ChildCount -1
                // this will cause the Treeview to leak this Node. 
                // so check that
