...
namespace System.Windows.Forms {
    ...
    public class ListView : Control {
        ...
        protected override void OnHandleCreated(EventArgs e) {
            ...
            int version = unchecked((int)SendMessage(NativeMethods.CCM_GETVERSION, 0, 0));
            if (version < 5) { 
            ...
            if (VirtualMode) {
                int callbackMask = (int) UnsafeNativeMethods.SendMessage(new HandleRef(this, this.Handle), NativeMethods.LVM_GETCALLBACKMASK, 0, 0); 
                    ...
                    if (nmhdr->code == NativeMethods.LVN_GETDISPINFO) { 
                        ...
                        if (VirtualMode && m.LParam != IntPtr.Zero) {
                            ...
                            if (selectedChanged) { 
                                ...
                                ListViewVirtualItemsSelectionRangeChangedEventArgs lvvisrce = new ListViewVirtualItemsSelectionRangeChangedEventArgs(odStateChange.iFrom, odStateChange.iTo - 1, (odStateChange.uNewState & NativeMethods.LVIS_SELECTED) != 0); 
                                OnVirtualItemsSelectionRangeChanged(lvvisrce);
                            }
                        }
                    } 
        ...
        protected override void WndProc(ref Message m) { 
            ...
            switch (m.Msg) {
                ...
                case NativeMethods.WM_PAINT:
                    ...
                    // win32 ListView fix - look for comments about vsWhidbey 243708 
                ...
                case NativeMethods.WM_TIMER:
                    if ((int)m.WParam != LVTOOLTIPTRACKING || !ComctlSupportsVisualStyles) {
                        base.WndProc(ref m);
                    } 
                    break;
                default: 
