...
namespace System.Windows.Forms { 
    ...
    public class ToolStripPanel : ContainerControl, IArrangedElement {
        ...
        private void MoveInsideContainer(ToolStrip toolStripToDrag, Point clientLocation) { 
            ...
            if (currentToolStripPanelRow != null && currentToolStripPanelRow.Visible && currentToolStripPanelRow.ToolStripPanel == this && currentToolStripPanelRow.DragBounds.Contains(clientLocation)) {
