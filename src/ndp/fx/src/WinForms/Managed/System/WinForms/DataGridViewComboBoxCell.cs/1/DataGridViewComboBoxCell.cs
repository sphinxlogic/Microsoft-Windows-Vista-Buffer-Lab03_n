...
{ 
    ...
    { 
        ...
        private void CheckDropDownList(int x, int y, int rowIndex) 
        {
            ...
            int dropHeight = Math.Min(GetDropDownButtonHeight(this.DataGridView.CachedGraphics, cellStyle), adjustedSize.Height - 2); 
        ...
        { 
            ...
            if (owningComboBoxColumn != null) 
            {
                ...
                { 
                    ...
                    int dropDownWidth = (int) UnsafeNativeMethods.SendMessage(new HandleRef(comboBox, comboBox.Handle), NativeMethods.CB_GETDROPPEDWIDTH, 0, 0);
        ...
        { 
            ...
            { 
                ...
                Rectangle dropDownButtonRect; 
                PaintPrivate(this.DataGridView.CachedGraphics,
                    cellBounds, 
                    cellBounds,
                    rowIndex,
                    cellState,
