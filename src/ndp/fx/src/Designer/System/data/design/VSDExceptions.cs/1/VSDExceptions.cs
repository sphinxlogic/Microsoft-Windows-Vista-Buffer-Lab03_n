...
namespace System.Data.Design { 
    ...
    /// <summary> 
    /// This is the internal exception error constants file
    /// Define each internal exception error by three constants: int code, string msg, bool showmsg 
    /// format of the const name: 
    /// XXX_YYYYYYY_CODE, (required)
    /// XXX_YYYYYYY_MSG,  (required) where XXX is the area name, e.g. DSD for DataSourceDesigner, YYYY is the exception name 
    /// XXX_YYYYYYY_SHOWMSG, (optional, default to false)
    /// </summary>
    internal class VSDExceptions{
        ...
        //###################################################################### 
        //
        // Error code for Common goes here from 0001 to 9999 
        //
        //######################################################################
        internal class COMMON{
            ...
            internal const int    SIMPLENAMESERVICE_NAMEOVERFLOW_CODE = START_CODE + 1; 

            internal const string NOT_A_NAMED_OBJECT_MSG = "Named object collection holds something that is not a named object";
            internal const int NOT_A_NAMED_OBJECT_CODE = START_CODE + 2;
        } 
        //######################################################################
        // 
        // Error code for DesignTime DataSource goes here from 20001 to 29999 
        //
        //###################################################################### 
        internal class DataSource {
            ...
            internal const int NO_CONNECTION_NAME_SERVICE_CODE = START_CODE + 1;
 
            internal const string TABLE_BELONGS_TO_OTHER_DATA_SOURCE_MSG = "This table belongs to another DataSource already";
            internal const int TABLE_BELONGS_TO_OTHER_DATA_SOURCE_CODE = START_CODE + 2;

            internal const string PARAMETER_NOT_FOUND_MSG = "No parameter named '{0}' found"; 
            internal const int PARAMETER_NOT_FOUND_CODE = START_CODE + 4;
            ...
            internal const int INVALID_PARAMETER_VALUE_CODE = START_CODE + 5;
 
            internal const string INVALID_SOURCE_VALUE_MSG = "SourceCollection can only hold objects of type Source";
            internal const int INVALID_SOURCE_VALUE_CODE = START_CODE + 6;
            ...
            internal const int CANNOT_GET_IDBPROVIDER_FOR_CONNECTION_CODE = START_CODE + 21;
            ...
            internal const int FACTORY_CANNOT_CREATE_COMMAND_BUILDERS_CODE = START_CODE + 33;
 
            internal const string FACTORY_COULD_NOT_CREATE_ADAPTER_MSG = "The provider factory failed to create an adapter."; 
            internal const int FACTORY_COULD_NOT_CREATE_ADAPTER_CODE = START_CODE + 34;
            ...
            internal const int FACTORY_COULD_NOT_CREATE_COMMAND_BUILDER_CODE = START_CODE + 35;

            internal const string CANNOT_GET_COMMAND_BUILDER_FROM_DBSOURCE_MSG = "Failed to get a command builder for the DbSource."; 
            internal const int CANNOT_GET_COMMAND_BUILDER_FROM_DBSOURCE_CODE = START_CODE + 36;
        } 
    } 
}
