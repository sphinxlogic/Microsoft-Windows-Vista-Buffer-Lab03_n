//------------------------------------------------------------------------------ 
// <copyright file="UndoEngine.cs" company="Microsoft">
...
namespace System.ComponentModel.Design { 
    ...
    /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine"]/*' /> 
    /// <devdoc>
    ...
    public abstract class UndoEngine : IDisposable { 
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoEngine"]/*' /> 
        /// <devdoc> 
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoInProgress"]/*' /> 
        /// <devdoc> 
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.Enabled"]/*' /> 
        /// <devdoc>
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.Undoing"]/*' />
        /// <devdoc>
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.Undone"]/*' />
        /// <devdoc> 
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.AddUndoUnit"]/*' />
        /// <devdoc>
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.CreateUndoUnit"]/*' />
        /// <devdoc> 
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.DiscardUndoUnit"]/*' />
        /// <devdoc> 
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.Dispose"]/*' />
        /// <devdoc> 
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.Dispose2"]/*' /> 
        /// <devdoc>
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.GetRequiredService"]/*' /> 
        /// <devdoc>
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.GetService"]/*' />
        /// <devdoc>
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.OnUndoing"]/*' />
        /// <devdoc>
        ///     This event is raised immediately before an undo action is performed.
        /// </devdoc> 
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.OnUndone"]/*' />
        /// <devdoc>
        ///     This event is raised immediately after an undo action is performed. It 
        ///     will always be raised even if an exception is thrown.
        /// </devdoc> 
        ...
        /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit"]/*' />
        /// <devdoc> 
        ...
        protected class UndoUnit { 
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.UndoUnit"]/*' />
            /// <devdoc>
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.Name"]/*' /> 
            /// <devdoc>
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.IsEmpty"]/*' />
            /// <devdoc>
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.UndoEngine"]/*' />
            /// <devdoc> 
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.Close"]/*' /> 
            /// <devdoc> 
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.ComponentAdded"]/*' /> 
            /// <devdoc>
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.ComponentAdding"]/*' /> 
            /// <devdoc> 
            ///     The undo engine will call this on the active undo
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.ComponentChanged"]/*' /> 
            /// <devdoc>
            ///     The undo engine will call this on the active undo 
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.ComponentChanging"]/*' /> 
            /// <devdoc> 
            ///     The undo engine will call this on the active undo
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.ComponentRemoved"]/*' /> 
            /// <devdoc> 
            ///     The undo engine will call this on the active undo
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.ComponentRemoving"]/*' /> 
            /// <devdoc>
            ///     The undo engine will call this on the active undo
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.ComponentRename"]/*' /> 
            /// <devdoc>
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.GetService"]/*' /> 
            /// <devdoc>
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.ToString"]/*' />
            /// <devdoc> 
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.Undo"]/*' />
            /// <devdoc>
            ...
            /// <include file='doc\UndoEngine.uex' path='docs/doc[@for="UndoEngine.UndoUnit.UndoCore"]/*' />
            /// <devdoc>
