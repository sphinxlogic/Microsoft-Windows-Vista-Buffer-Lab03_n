...
/* 
 */ 
[assembly: System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Scope="member", Target="System.Windows.Forms.Design.ToolStripCollectionEditor..ctor()")]
...
namespace System.Windows.Forms.Design {
    ...
    internal class ToolStripCollectionEditor : CollectionEditor
    {
        ...
        /// <include file='doc\ToolStripCollectionEditor.uex' path='docs/doc[@for="ToolStripCollectionEditor.HelpTopic"]/*' /> 
        /// <devdoc>
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value) {
            ...
            // get ahold of the designer for the component that is launching this editor.  If it
            // is a winbar, then we want to let it know this editor is up. 
            //
        ...
        protected class ToolStripItemEditorForm : CollectionEditor.CollectionForm 
        {
            ...
            private System.Windows.Forms.ComboBox newItemTypes;
...
*/
                    ...
                    if (value != this._targetToolStripCollection) 
                    {
                        ...
                        { 
                            ...
                            if (Context != null) {
                                ...
                                this.selectedItemProps.Site = new CollectionEditor.PropertyGridSite(Context, this.selectedItemProps); 
        ...
        #region Windows Form Designer generated code
            ...
            {
                System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ToolStripItemEditorForm)); 
                ...
                this.selectedItemProps = new VsPropertyGrid(Context /*IServiceProvider*/); 
                ...
                this.tableLayoutPanel.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 274F)); 
                ...
                this.addTableLayoutPanel.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 100F));
                this.addTableLayoutPanel.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle()); 
                this.addTableLayoutPanel.Controls.Add(this.btnAddNew, 1, 0); 
                this.addTableLayoutPanel.Controls.Add(this.newItemTypes, 0, 0);
                this.addTableLayoutPanel.Margin = new System.Windows.Forms.Padding(0, 3, 3, 3); 
                ...
                this.btnAddNew.Margin = new System.Windows.Forms.Padding(3, 0, 0, 0); 
                this.btnAddNew.Name = "btnAddNew";
                // 
                // newItemTypes
                //
                resources.ApplyResources(this.newItemTypes, "newItemTypes");
                this.newItemTypes.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList; 
                this.newItemTypes.FormattingEnabled = true;
                this.newItemTypes.Margin = new System.Windows.Forms.Padding(0, 0, 3, 0); 
                this.newItemTypes.Name = "newItemTypes"; 
                this.newItemTypes.DrawMode = System.Windows.Forms.DrawMode.OwnerDrawVariable;
                ...
                this.okCancelTableLayoutPanel.Margin = new System.Windows.Forms.Padding(3, 6, 0, 0);
                ...
                this.lblItems.Margin = new System.Windows.Forms.Padding(0, 3, 3, 0);
                this.lblItems.Name = "lblItems"; 
                //
                // selectedItemName
                //
                resources.ApplyResources(this.selectedItemName, "selectedItemName"); 
                this.selectedItemName.Margin = new System.Windows.Forms.Padding(3, 3, 3, 0);
                this.selectedItemName.Name = "selectedItemName"; 
                // 
                // selectedItemProps
                // 
                this.selectedItemProps.CommandsVisibleIfAvailable = false;
                resources.ApplyResources(this.selectedItemProps, "selectedItemProps");
                this.selectedItemProps.Margin = new System.Windows.Forms.Padding(3, 3, 0, 3);
                ...
                this.lblMembers.Margin = new System.Windows.Forms.Padding(0, 3, 3, 0);
                ...
                this.listBoxItems.Margin = new System.Windows.Forms.Padding(0, 3, 3, 3); 
                ...
                this.btnMoveUp.Margin = new System.Windows.Forms.Padding(3, 3, 18, 0);
                this.btnMoveUp.Name = "btnMoveUp"; 
                //
                // btnMoveDown
                //
                resources.ApplyResources(this.btnMoveDown, "btnMoveDown"); 
                this.btnMoveDown.Margin = new System.Windows.Forms.Padding(3, 1, 18, 3);
                this.btnMoveDown.Name = "btnMoveDown"; 
                // 
                // btnRemove
                // 
                resources.ApplyResources(this.btnRemove, "btnRemove");
                this.btnRemove.Margin = new System.Windows.Forms.Padding(3, 3, 18, 3);
                ...
                //events
                this.HelpButtonClicked += new System.ComponentModel.CancelEventHandler(this.ToolStripCollectionEditor_HelpButtonClicked);
                ...
                this.selectedItemName.Paint += new System.Windows.Forms.PaintEventHandler(this.OnselectedItemName_Paint);
                this.listBoxItems.SelectedIndexChanged += new System.EventHandler(this.OnlistBoxItems_SelectedIndexChanged); 
                this.listBoxItems.DrawItem += new System.Windows.Forms.DrawItemEventHandler(this.OnlistBoxItems_DrawItem);
            ...
            private void OnComboHandleCreated(object sender, EventArgs e){ 
                ...
                this.newItemTypes.MeasureItem += new System.Windows.Forms.MeasureItemEventHandler(this.OnlistBoxItems_MeasureItem);
                this.newItemTypes.DrawItem += new System.Windows.Forms.DrawItemEventHandler(this.OnlistBoxItems_DrawItem);

            } 
            /// <summary>
            /// Add a new item to our list.  This will add a preview item 
            /// and a listbox item as well. 
            /// </summary>
            ...
            /// <param name="e"></param> 
            private void OnFormLoad(System.Object sender, System.EventArgs e)
            { 
                // Set the font as appropriate.
                this.newItemTypes.ItemHeight = Math.Max(ICON_HEIGHT, Font.Height);
            ...
            private void OnbtnOK_Click(System.Object sender, System.EventArgs e)
            {
                ...
                //VSWhidbey 456449 - we dont need to call Hide here DialogResult does it for us....
            } 
            ...
            /// </summary>
            private void OnbtnRemove_Click(System.Object sender, System.EventArgs e) 
            {
            ...
            /// </summary>
            private void OnbtnMoveDown_Click(System.Object sender, System.EventArgs e)
            {
            ...
            /// </summary>
            private void OnbtnMoveUp_Click(System.Object sender, System.EventArgs e) 
            {
                ToolStripItem currentItem = (ToolStripItem)listBoxItems.SelectedItem; 
                int currentIndex = listBoxItems.Items.IndexOf(currentItem); 
                if (currentIndex > 1){
            ...
            /// </summary> 
            private void OnnewItemTypes_DropDown(System.Object sender, System.EventArgs e)
            {
                ...
                { 
                    ...
                    using (Graphics g = newItemTypes.CreateGraphics())
                    {
                        ...
                        { 
                            ...
                            dropDownHeight += (Font.Height + SEPARATOR_HEIGHT) +2*IMAGE_PADDING; 
                        } 
                    }
            ...
            private void OnnewItemTypes_SelectionChangeCommitted(System.Object sender, System.EventArgs e)
            { 
                // get the item type
                //
            ...
            /// </summary>
            private void OnnewItemTypes_SelectedIndexChanged(System.Object sender, System.EventArgs e)
            { 
            ...
            { 
                ...
                e.ItemHeight = Math.Max(ICON_HEIGHT + separatorHeight, measureFont.Height + separatorHeight) +2*IMAGE_PADDING;
			}	 
 
            /// <summary>
            /// Custom draw the list box item with the icon and the text.  We actually share this code b/t the list box and the combobox. 
            /// </summary>
            private void OnlistBoxItems_DrawItem(System.Object sender, System.Windows.Forms.DrawItemEventArgs e)
            {
                // okay, nevermind. 
                //
                if (e.Index == -1) { 
                ...
                if (sender is ListBox) {
                    ...
                    Debug.Fail("Unexpected sender, who's calling DrawItem");
                    return; 
                }
                ...
                if (itemType != null) 
                {
                    ...
                    imageBounds.Size = new Size(ICON_HEIGHT, ICON_HEIGHT); 
                    int xOffset = (isComboEditBox) ? 0 : IMAGE_PADDING*2; 
                    imageBounds.Offset(xOffset,IMAGE_PADDING);
 
                    if (drawSeparator) {
                        imageBounds.Offset(0,SEPARATOR_HEIGHT);
                    }
                    if (indentItem) { 
                        imageBounds.X += ICON_HEIGHT+INDENT_SPACING;
                    } 
                    ...
                    if (tbxBitmap != null) { 
                       if (isComboEditBox) {
                           ...
                           e.Graphics.DrawImage(tbxBitmap, e.Bounds.X, e.Bounds.Y, ICON_HEIGHT, ICON_HEIGHT); 
                       }
                       else { 
                    ...
                    textBounds.X = imageBounds.Right + TEXT_IMAGE_SPACING;
                    textBounds.Y = imageBounds.Top-IMAGE_PADDING; 
                    if (!isComboEditBox) {
                        textBounds.Y+=IMAGE_PADDING*2;
                    }
                    ...
                    if (drawSeparator) {
                        fillBounds.Y += SEPARATOR_HEIGHT;
                        fillBounds.Height -= SEPARATOR_HEIGHT;
                    } 
            ...
            /// <param name="sender"></param> 
            /// <param name="e"></param>
            private void OnlistBoxItems_SelectedIndexChanged(System.Object sender, System.EventArgs e) 
            {
                ...
                { 
                    ...
                    { 
                        ...
                        this.selectedItemProps.SelectedObjects = new object[]{toolStripCustomTypeDescriptor};
                    } 
                    else
                    { 
                        // if null parentStrip or non sited then dont show the properties... 
                        this.selectedItemProps.SelectedObjects = null;
                    } 
                }
                else {
                    this.selectedItemProps.SelectedObjects = objList;
                } 
            ...
            private void OnselectedItemName_Paint(System.Object sender, System.Windows.Forms.PaintEventArgs e)
            { 
                    ...
                    switch (listBoxItems.SelectedItems.Count)
                    {
                        ...
                        case 1:
                            ...
                            if (selectedItem.Site != null) { 
                                ...
                                //e.Graphics.DrawString(itemName, selectedItemName.Font, SystemBrushes.WindowText, new Rectangle(classWidth + GdiPlusFudge, 0, bounds.Width, bounds.Height));
                        ...
                        case 0: 
                            ...
                            if (label != null) 
                            { 
                                label.Text = SR.GetString(SR.ToolStripItemCollectionEditorLabelNone);
                            } 
                            e.Graphics.DrawString(SR.GetString(SR.ToolStripItemCollectionEditorLabelNone), boldFont, SystemBrushes.WindowText, bounds, stringFormat);
                            break;
                        default:
                            e.Graphics.FillRectangle(SystemBrushes.Control , bounds); // erase background 
                            if (label != null)
                            { 
                                label.Text = SR.GetString(SR.ToolStripItemCollectionEditorLabelMultipleItems); 
                            }
                            e.Graphics.DrawString(SR.GetString(SR.ToolStripItemCollectionEditorLabelMultipleItems), boldFont, SystemBrushes.WindowText, bounds, stringFormat); 
                            break;
            ...
            /// <summary>
            /// Removes an item from the list and the preview winbar, as 
            /// </summary>
            ...
            { 
                ...
                { 
                    ...
                    // destroy the item.  This will remove it from the 
                    // designer as well.
                    // 
                } 
                finally
            ...
            private class ImageComboBox : ComboBox { 
                ...
                private Rectangle ImageRect {
                    get { 
                        ...
                        {
                            return new Rectangle(4 + SystemInformation.HorizontalScrollBarThumbWidth, 3, ICON_HEIGHT, ICON_HEIGHT); 
                        }
                        return new Rectangle(3, 3, ICON_HEIGHT, ICON_HEIGHT); 
                    } 
                }
