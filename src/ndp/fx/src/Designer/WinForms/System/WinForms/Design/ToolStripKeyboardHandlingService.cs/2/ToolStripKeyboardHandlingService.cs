//------------------------------------------------------------------------------ 
// <copyright file="ToolStripKeyboardHandlingService.cs" company="Microsoft">
...
{ 
    ...
    /// <include file='doc\ToolStripKeyboardHandlingService.uex' path='docs/doc[@for="ToolStripKeyboardHandlingService"]/*' />
    /// <devdoc> 
    ...
    { 
        ...
        /// <include file='doc\ToolStripKeyboardHandlingService.uex' path='docs/doc[@for="ToolStripKeyboardHandlingService.ToolStripKeyboardHandlingService"]/*' />
        /// <devdoc>
        ...
        /// <include file='doc\ToolStripKeyboardHandlingService.uex' path='docs/doc[@for="ToolStripKeyboardHandlingService.SelectionService"]/*' />
        /// <devdoc>
        ...
        /// <include file='doc\ToolStripKeyboardHandlingService.uex' path='docs/doc[@for="ToolStripKeyboardHandlingService.GetNextControlInTab"]/*' />
        /// <devdoc> 
        ...
        private void OnComponentRemoved(object sender, ComponentEventArgs e) 
        {
            ...
            { 
                ...
                if (keyboardHandlingService != null)
                {
                    ...
                    designerHost.RemoveService(typeof(ToolStripKeyboardHandlingService));
                } 
            }
        }
            ...
            { 
                ...
                { 
                    ...
                    { 
                        ...
                        { 
                            mcs.RemoveCommand(oldCommandPaste);
                        }
                        ...
                        {
                            mcs.AddCommand(newCommandPaste); 
                        } 
                    }
                } 
            }
        ...
        /// <include file='doc\ToolStripKeyboardHandlingService.uex' path='docs/doc[@for="ToolStripKeyboardHandlingService.EnterEditMode"]/*' />
        /// <devdoc> 
        ...
        /// <include file='doc\ToolStripKeyboardHandlingService.uex' path='docs/doc[@for="ToolStripKeyboardHandlingService.OnKeyMove"]/*' />
        /// <devdoc>
        ...
        /// <include file='doc\ToolStripKeyboardHandlingService.uex' path='docs/doc[@for="ToolStripKeyboardHandlingService.OnKeyCancel"]/*' /> 
        /// <devdoc>
        ...
        /// <include file='doc\ToolStripKeyboardHandlingService.uex' path='docs/doc[@for="ToolStripKeyboardHandlingService.SelectItem"]/*' />
        /// <devdoc> 
        ...
        /// <include file='doc\ToolStripKeyboardHandlingService.uex' path='docs/doc[@for="ToolStripKeyboardHandlingService.OnSelectionChanging"]/*' />
        /// <devdoc>
        ...
        /// <include file='doc\ToolStripKeyboardHandlingService.uex' path='docs/doc[@for="ToolStripKeyboardHandlingService.OnSelectionChanged"]/*' />
        /// <devdoc> 
        ///     Called when the current selection changes.  Here we determine what 
        ///     commands can and can't be enabled.
        /// </devdoc> 
        ...
        /// <include file='doc\ToolStripKeyboardHandlingService.uex' path='docs/doc[@for="ToolStripKeyboardHandlingService.ProcessRightLeft"]/*' />
        /// <devdoc>
        ...
        /// <include file='doc\ToolStripKeyboardHandlingService.uex' path='docs/doc[@for="ToolStripKeyboardHandlingService.ProcessUpDown"]/*' /> 
        /// <devdoc>
        ...
        { 
            ...
            if (mcs != null) 
            {
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeySelectNext)); 
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeySelectPrevious)); 
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeyDefaultAction));
 
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeyMoveUp));
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeyMoveDown));
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeyMoveLeft));
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeyMoveRight)); 

                oldCommands.Add(mcs.FindCommand(MenuCommands.KeyNudgeUp)); 
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeyNudgeDown)); 
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeyNudgeLeft));
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeyNudgeRight)); 

                oldCommands.Add(mcs.FindCommand(MenuCommands.KeySizeWidthIncrease));
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeySizeHeightIncrease));
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeySizeWidthDecrease)); 
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeySizeHeightDecrease));
 
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeyCancel)); 
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeyReverseCancel));
                oldCommands.Add(mcs.FindCommand(StandardCommands.Copy)); 
                oldCommands.Add(mcs.FindCommand(StandardCommands.SelectAll));
                oldCommands.Add(mcs.FindCommand(MenuCommands.KeyInvokeSmartTag));

                oldCommands.Add(mcs.FindCommand(StandardCommands.Cut)); 
                oldCommands.Add(mcs.FindCommand(MenuCommands.Delete));
            } 
        } 
        ...
        /// <include file='doc\ToolStripKeyboardHandlingService.uex' path='docs/doc[@for="ToolStripKeyboardHandlingService.RotateParent"]/*' />
        /// <devdoc> 
        ...
        /// <include file='doc\ToolStripKeyboardHandlingService.uex' path='docs/doc[@for="ToolStripKeyboardHandlingService.RotateTab"]/*' />
        /// <devdoc> 
