...
namespace System.Drawing.Design { 
    ...
    public class ColorEditor : UITypeEditor { 
        ...
        private class ColorPalette : Control {
            ...
            static private void FillRectWithCellBounds(int across, int down, ref Rectangle rect) {
            ...
            static private Point GetCell2DFromLocationMouse(int x, int y) {
            ...
            static private int GetCellFromLocationMouse(int x, int y) {
                return Get1DFrom2D(GetCell2DFromLocationMouse(x, y)); 
            }

            static private int Get1DFrom2D(Point pt) {
                return Get1DFrom2D(pt.X, pt.Y); 
            }
 
            static private int Get1DFrom2D(int x, int y) { 
                if (x == -1 || y == -1) {
                    return -1; 
                }
            ...
            static internal Point Get2DFrom1D(int cell) {
            ...
            static private void PaintValue(Color color, Graphics g, Rectangle rect) { 
            ...
            public class ColorPaletteAccessibleObject : ControlAccessibleObject {
                ...
                public class ColorCellAccessibleObject : AccessibleObject { 
                    ...
                    /// <include file='doc\ColorEditor.uex' path='docs/doc[@for="ColorCellAccessibleObject.State"]/*' />
        ...
        private class ColorUI : Control { 
            ...
            /// </devdoc> 
            static private object[] GetConstants(Type enumType) {
            ...
            private void InitializeComponent() { 
                ...
                AccessibleName = SR.GetString(SR.ColorEditorAccName);
