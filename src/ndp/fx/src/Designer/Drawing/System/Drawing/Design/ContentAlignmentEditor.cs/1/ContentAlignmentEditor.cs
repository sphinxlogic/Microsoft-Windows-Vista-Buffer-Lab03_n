    ...
    public class ContentAlignmentEditor : UITypeEditor {
        ...
        private class ContentUI : Control {
            ...
            private void InitComponent() {
                ...
                this.AccessibleName = SR.GetString(SR.ContentAlignmentEditorAccName);
            ...
            private RadioButton CheckedControl {
                ...
                set {
                    ...
                    if (value.IsHandleCreated) {
                        UnsafeNativeMethods.NotifyWinEvent((int) AccessibleEvents.Focus, new HandleRef(value, value.Handle), UnsafeNativeMethods.OBJID_CLIENT, 0); 
                    } 
                }
            } 
        }
