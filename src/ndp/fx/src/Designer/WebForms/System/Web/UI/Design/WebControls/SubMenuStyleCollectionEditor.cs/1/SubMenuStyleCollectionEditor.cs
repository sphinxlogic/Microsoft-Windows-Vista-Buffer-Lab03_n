...
namespace System.Web.UI.Design.WebControls { 
    ...
    public class SubMenuStyleCollectionEditor : CollectionEditor {
        ...
        /// <include file='doc\SubMenuStyleCollectionEditor.uex' path='docs/doc[@for="SubMenuStyleCollectionEditor.SubMenuStyleCollectionEditor"]/*' />
        /// <devdoc> 
        /// <para>Initializes a new instance of the <see cref='System.Web.UI.Design.WebControls.SubMenuStyleCollectionEditor'/> class.</para> 
        /// </devdoc>
        public SubMenuStyleCollectionEditor(Type type) : base(type) { 
        }

        /// <include file='doc\SubMenuStyleCollectionEditor.uex' path='docs/doc[@for="SubMenuStyleCollectionEditor.CanSelectMultipleInstances"]/*' />
        /// <devdoc> 
        ...
        protected override CollectionForm CreateCollectionForm() {
            ...
            form.Text = SR.GetString(SR.CollectionEditorCaption, "SubMenuStyle"); 
            return form;
        } 
 
        /// <include file='doc\SubMenuStyleCollectionEditor.uex' path='docs/doc[@for="SubMenuStyleCollectionEditor.CreateInstance"]/*' />
        /// <devdoc> 
        ...
        /// <include file='doc\SubMenuStyleCollectionEditor.uex' path='docs/doc[@for="SubMenuStyleCollectionEditor.CreateNewItemTypes"]/*' /> 
        /// <devdoc>
