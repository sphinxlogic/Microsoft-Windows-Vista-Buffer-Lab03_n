...
namespace System.Web.UI.Design.Util { 
    ...
    internal abstract class WizardForm : TaskFormBase {
        ...
        /// <devdoc> 
        /// </devdoc>
        /// Not used, according to FxCop.  Commenting out per [....]'s request.
        /*[
        Browsable(false), 
        ]
        public WizardPanel InitialPanel { 
            get { 
        ...
        private void InitializeComponent() {
            ...
            this._wizardButtonsTableLayoutPanel.Location = new System.Drawing.Point(239, 384);
            ...
            this._wizardButtonsTableLayoutPanel.Size = new System.Drawing.Size(317, 23);
        ...
        private void InitializeUI() { 
            ...
            _nextButton.Text = SR.GetString(SR.Wizard_NextButton); 
            _previousButton.Text = SR.GetString(SR.Wizard_PreviousButton);
            _finishButton.Text = SR.GetString(SR.Wizard_FinishButton);
        }
