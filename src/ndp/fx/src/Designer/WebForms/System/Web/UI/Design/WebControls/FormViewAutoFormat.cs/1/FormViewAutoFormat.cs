//------------------------------------------------------------------------------ 
// <copyright file="FormViewAutoFormats.cs" company="Microsoft">
...
namespace System.Web.UI.Design.WebControls { 
    ...
    internal sealed class FormViewAutoFormat : DesignerAutoFormat {
        ...
        public override void Apply(Control control) {
            Debug.Assert(control is FormView, "FormViewAutoFormat:ApplyScheme- control is not FormView"); 
            if (control is FormView) {
                Apply(control as FormView);
            }
        } 
        ...
        private void Apply(FormView view) { 
            ...
            switch (gridLines) { 
                ...
                default:
                    view.GridLines = GridLines.None; break; 
            } 
        ...
        public override Control GetPreviewControl(Control runtimeControl) { 
            ...
            if (control != null) {
                ...
                if (formView != null && host != null) { 
                    TemplateBuilder itemTemplate = formView.ItemTemplate as TemplateBuilder; 
                    if ((itemTemplate != null && itemTemplate.Text.Length == 0) || formView.ItemTemplate == null) {
                        string text = "####&nbsp;&nbsp;####<br/>####&nbsp;&nbsp;####<br/>####&nbsp;&nbsp;####<br/>####&nbsp;&nbsp;####"; 
                        formView.ItemTemplate = ControlParser.ParseTemplate(host, text);
                        formView.RowStyle.HorizontalAlign = HorizontalAlign.Center;
                    }
                    formView.HorizontalAlign = HorizontalAlign.Center; 
                    formView.Width = new Unit(80, UnitType.Percentage);
                } 
            } 
            return control;
        } 
