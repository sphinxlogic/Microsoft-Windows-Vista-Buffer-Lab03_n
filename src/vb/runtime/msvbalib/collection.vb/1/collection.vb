        ...
        Public Sub Add(ByVal Item As Object, Optional ByVal Key As String = Nothing, Optional ByVal Before As Object = Nothing, Optional ByVal After As Object = Nothing) 
            ...
            If Key IsNot Nothing Then 
                ...
                Catch ex As ArgumentException 
                    Debug.Assert(m_KeyedNodesHash.ContainsKey(Key), "We got an argumentexception from a hashtable add, but it wasn't a duplicate key. What other kind of argument exception could we get here?")
