            ...
            If Not CollectOnlyOperators Then
                ...
                For Index As Integer = 0 To Candidates.Count - 1 
                    ...
                    If Not ExactSignature Then
                        ...
                        End If
                    Else 
                        Debug.Assert(IsOrInheritsFrom(Existing.DeclaringType, NewCandidate.DeclaringType), _
                        ...
                        'the derived candidate cannot hide the base candidate. 
                        '
...
continueloop:
        ...
        Friend Shared Function CollectOverloadCandidates( _ 
            ...
            ByRef RejectedForTypeArgumentCount As Integer) As List(Of Method) 
            ...
            Do
                ...
                Do 
                    ...
                    'filter out procedures that cannot accept the number of supplied arguments. 
                    ...
                    'If type arguments have been supplied, filter out procedures that don't have an 
