    ...
    Public NotInheritable Class Utils 
        ...
        Public Shared Function GetResourceString(ByVal ResourceKey As String, ByVal ParamArray Args() As String) As String
            ...
            Try
                ...
                FormattedString = String.Format(System.Threading.Thread.CurrentThread.CurrentUICulture, UnformattedString, Args)
        ...
        Friend Shared Function MapHRESULT(ByVal lNumber As Integer) As Integer
            ...
            Select Case lNumber
                ...
                Case &H800706BAI
                    ...
                    ' FACILITY_WINDOWS - differs from FACILITY_WIN32
