...
Namespace Microsoft.VisualBasic.CompilerServices 
    ...
    Friend Class Symbols 
        ...
        Friend Shared Function IsOrInheritsFrom(ByVal Derived As System.Type, ByVal Base As System.Type) As Boolean 
            ...
            Else If IsInterface(Derived) Then
            ...
            Else if IsClass(Base) AndAlso IsClassOrValueType(Derived) 
...
#End If
            ...
            Private Shared Function FilterInvalidMembers(Members As MemberInfo()) As MemberInfo() 
                ...
                If ValidMemberCount = Members.Length Then
                    Return Members
                Else If ValidMemberCount > 0 Then 
            ...
            Private Function LookupDefaultMembers(ByRef DefaultMemberName As String) As MemberInfo()
            ...
            Friend Function GetMembers( _ 
                ...
                If MemberName = "" Then
                    ...
                    Else 
                        Result = Me.LookupDefaultMembers(MemberName) 'MemberName is set during this call. 
                    End If
            ...
            Private Sub CheckForClassExtendingCOMClass()
                If Me.IsCOMObject AndAlso m_Type.FullName <> "System.__ComObject" AndAlso m_Type.BaseType.FullName <> "System.__ComObject" Then
