...
Namespace Microsoft.VisualBasic.FileIO
    ...
    Public Class FileSystem
        ...
        Private Shared Sub CopyOrMoveDirectory(ByVal operation As CopyOrMove, _ 
            ...
            ' Therefore we also demand Read permission on target path. 
            ...
            If TargetDirectoryFullPath.Length > SourceDirectoryFullPath.Length AndAlso _ 
                ...
                If TargetDirectoryFullPath.Chars(SourceDirectoryFullPath.Length) = IO.Path.DirectorySeparatorChar Then
                    Throw GetInvalidOperationException(ResID.MyID.IO_CyclicOperation)
                End If
            End If 
            ...
            If showUI <> UIOptionInternal.NoUI AndAlso Environment.UserInteractive Then
                ' If ShowUI AND UserInteractive, attempt to call Shell function. 
        ...
        Private Shared Sub CopyOrMoveFile(ByVal operation As CopyOrMove, _ 
            ...
            ' Demand FileIOPermission on the given paths.
                ...
                If overwrite Then ' User wants to overwrite destination. 
                    ...
                    If Environment.OSVersion.Platform = PlatformID.Win32NT Then ' Platforms supporting MoveFileEx. 
                        ...
                        Try 
                            ...
                            ' GetLastWin32Error has to be close to PInvoke call.
                            If Not succeed Then
                                ThrowWinIOError(Runtime.InteropServices.Marshal.GetLastWin32Error())
                            End If 
                        Catch
                            Throw 
                        Finally 
        ...
        Private Shared Sub DeleteDirectoryInternal(ByVal directory As String, ByVal onDirectoryNotEmpty As DeleteDirectoryOption, _
            ...
            ' Throw exception if deleting root directory. 
        ...
        Private Shared Sub ShellFileOperation(ByVal OperationType As SHFileOperationType, ByVal OperationFlags As ShFileOperationFlags, _ 
            ...
            ' Demand FileIOPermission, defense in depth.
...
#End If 
        ...
        Private Shared ReadOnly m_SeparatorChars() As Char = { _ 
            IO.Path.DirectorySeparatorChar, IO.Path.AltDirectorySeparatorChar, IO.Path.VolumeSeparatorChar, IO.Path.PathSeparator}
    ...
    ''' </summary> 
    ''' <remarks>
    ''' avoid Integer values that VB Compiler 
...
'
' - Including the Overwrite option and ShowUI in one method is confusing
