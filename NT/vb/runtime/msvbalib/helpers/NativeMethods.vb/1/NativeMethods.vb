...
Namespace Microsoft.VisualBasic.CompilerServices
    ...
    Friend NotInheritable Class NativeMethods
        ...
        <PreserveSig()> Friend Declare Auto Function _ 
            WaitForInputIdle _
                Lib "user32" (ByVal Process As IntPtr, ByVal Milliseconds As Integer) As Integer 
        ...
        <PreserveSig()> Friend Declare Function _ 
            WaitForSingleObject _
                Lib "kernel32" (ByVal hHandle As IntPtr, ByVal dwMilliseconds As Integer) As Integer 
