...
#End If
        ...
        Friend NotInheritable Class PROCESS_INFORMATION
            ...
            Friend Sub Dispose() Implements IDisposable.Dispose 
                If hProcess <> IntPtr.Zero AndAlso hProcess <> NativeTypes.INVALID_HANDLE Then
                    NativeMethods.CloseHandle(hProcess)
                    hProcess = NativeTypes.INVALID_HANDLE
                End If 

                If Not hThread <> IntPtr.Zero AndAlso hThread <> NativeTypes.INVALID_HANDLE Then 
                    NativeMethods.CloseHandle(hThread) 
                    hThread = NativeTypes.INVALID_HANDLE
                End If 
