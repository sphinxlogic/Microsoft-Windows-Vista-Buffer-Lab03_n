...
[assembly: System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Reliability", "CA2006:UseSafeHandleToEncapsulateNativeResources", Scope="member", Target="System.Drawing.SafeNativeMethods+Gdip.hAtom")] 
...
namespace System.Drawing {
    ...
    internal class SafeNativeMethods { 
        ...
        internal class Gdip { 
            ...
            static string AtomName {
                get { 
                    if (atomName == null) { 
                        atomName = "GDI+Atom" + GetCurrentProcessId().ToString(CultureInfo.InvariantCulture);
                    } 
                    return atomName;
                }
            }
            ...
            /// </devdoc>
            static bool EnsureAtomInitialized() { 
...
*/ 
                ...
                // 
#if DEBUG 
                alreadyInitialized = (!GdiPlusIgnoreAtom.Enabled && EnsureAtomInitialized());
#else 
                alreadyInitialized = EnsureAtomInitialized();
#endif
...
*/ 
 	    ...
 	    // When we get notification that the process is terminating, we will
            ...
            internal static int GdipDeletePath(HandleRef path) {
                if (IsShutdown) return SafeNativeMethods.Gdip.Ok;
...
//        TA_TOP        = 0, 
        ...
        */
        ...
        public class ENHMETAHEADER { 
            ...
            public int  rclBounds_left = 0;
            public int  rclBounds_top = 0; 
            public int  rclBounds_right = 0;
            public int  rclBounds_bottom = 0;
            // rclFrame was a by-value RECTL structure
            public int  rclFrame_left = 0; 
            public int  rclFrame_top  = 0;
            public int  rclFrame_right = 0; 
            public int  rclFrame_bottom = 0; 
            public int  dSignature = 0;
            public int  nVersion = 0; 
            public int  nBytes = 0;
            public int  nRecords = 0;
            public short nHandles = 0;
            public short sReserved = 0; 
            public int  nDescription = 0;
            public int  offDescription = 0; 
            public int  nPalEntries = 0; 
            // szlDevice was a by-value SIZE structure
            public int  szlDevice_cx = 0; 
            public int  szlDevice_cy = 0;
            // szlMillimeters was a by-value SIZE structure
            public int  szlMillimeters_cx = 0;
            public int  szlMillimeters_cy = 0; 
            public int  cbPixelFormat = 0;
            public int  offPixelFormat = 0; 
            public int  bOpenGL = 0; 
        }
        ...
        { 
            ...
            internal int union2 = 0;
            internal int union3 = 0;
...
*/ 
        ...
        public class DEVMODE {
            ...
            public short dmSpecVersion = 0; 
            public short dmDriverVersion = 0;
            public short dmSize = 0; 
            public short dmDriverExtra = 0; 
            public int dmFields = 0;
            ...
            public short dmDefaultSource = 0; 
            ...
            public short dmLogPixels = 0; 
            public int dmBitsPerPel = 0; 
            public int dmPelsWidth = 0;
            public int dmPelsHeight = 0; 
            public int dmDisplayFlags = 0;
            public int dmDisplayFrequency = 0;
            public int dmICMMethod = 0;
            public int dmICMIntent = 0; 
            public int dmMediaType = 0;
            public int dmDitherType = 0; 
            public int dmICCManufacturer = 0; 
            public int dmICCModel = 0;
            public int dmPanningWidth = 0; 
            public int dmPanningHeight = 0;
