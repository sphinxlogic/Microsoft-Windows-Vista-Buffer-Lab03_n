    ...
    public sealed class Graphics : MarshalByRefObject, IDisposable, IDeviceContext 
    {
        ...
        public CompositingMode CompositingMode {
            ...
            set { 
                ...
                if (!ClientUtils.IsEnumValid(value, (int)value, (int)CompositingMode.SourceOver, (int)CompositingMode.SourceCopy)){ 
        ...
        public CompositingQuality CompositingQuality {
            ...
            set { 
                ...
                if (!ClientUtils.IsEnumValid(value, (int)value, (int)CompositingQuality.Invalid, (int)CompositingQuality.AssumeLinear))
                { 
        ...
        public TextRenderingHint TextRenderingHint {
            ...
            set { 
                ...
                if (!ClientUtils.IsEnumValid(value, (int)value, (int)TextRenderingHint.SystemDefault, (int)TextRenderingHint.ClearTypeGridFit))
                { 
        ...
        public SmoothingMode SmoothingMode {
            ...
            set {
                //valid values are 0xffffffff to 0x4 
                if (!ClientUtils.IsEnumValid(value, (int)value, (int)SmoothingMode.Invalid, (int)SmoothingMode.AntiAlias))
                {
        ...
        public PixelOffsetMode PixelOffsetMode { 
            ...
            set {
                //valid values are 0xffffffff to 0x4 
                if (!ClientUtils.IsEnumValid(value, (int)value, (int)PixelOffsetMode.Invalid, (int)PixelOffsetMode.Half))
                { 
        ...
        public InterpolationMode InterpolationMode {
            ...
            set { 
                ...
                if (!ClientUtils.IsEnumValid(value, (int)value, (int)InterpolationMode.Invalid, (int)InterpolationMode.HighQualityBicubic)) 
                {
        ...
        public GraphicsUnit PageUnit {
            ...
            set {
                ...
                if (!ClientUtils.IsEnumValid(value, (int)value, (int)GraphicsUnit.World, (int)GraphicsUnit.Millimeter))
                {
            ...
            using( DeviceContext dc = DeviceContext.FromHwnd( IntPtr.Zero )){  // screen DC
                ...
                try{ 
                    int result = SafeNativeMethods.BitBlt(targetDC, destinationX, destinationY, destWidth, destHeight, 
                                                          screenDC, sourceX, sourceY, (int) copyPixelOperation);
        ...
        public void TransformPoints (CoordinateSpace destSpace,
            ...
            int status = SafeNativeMethods.Gdip.GdipTransformPoints(new HandleRef(this, this.NativeGraphics), (int)destSpace, 
        ...
        public void TransformPoints(CoordinateSpace destSpace,
            ...
            IntPtr buf = SafeNativeMethods.Gdip.ConvertPointToMemory(pts); 
            int status = SafeNativeMethods.Gdip.GdipTransformPointsI(new HandleRef(this, this.NativeGraphics), (int)destSpace,
                                                      (int)srcSpace, buf, pts.Length);
