...
/* SSS_WARNINGS_OFF */        public const int SPI_GETWINDOWSEXTENSION              =  92; /* SSS_WARNINGS_ON */ 
    ...
    [DllImport(ExternDll.Mscoree, CharSet=CharSet.Auto, BestFitMapping=false)] 
    ...
    /*
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal static class SECURITY_DESCRIPTOR { 
        ...
        [DllImport(ExternDll.Kernel32, CharSet=System.Runtime.InteropServices.CharSet.Auto, SetLastError=true)]
        public static extern bool GetExitCodeProcess(SafeHandle processHandle, out int exitCode); 
        [DllImport(ExternDll.Kernel32, CharSet=System.Runtime.InteropServices.CharSet.Auto)]
        public static extern bool GetVersionEx([In, Out] OSVERSIONINFO ver); 
        [DllImport(ExternDll.Advapi32, CharSet=System.Runtime.InteropServices.CharSet.Unicode, SetLastError=true, BestFitMapping=false)] 
