...
namespace System.Security.Cryptography.X509Certificates {
    ...
    public class X509Certificate2 : X509Certificate { 
        ...
        public X509Certificate2 (X509Certificate certificate) : base(certificate) {
            ...
            X509Certificate2 source = certificate as X509Certificate2; 
            if (source != null)
                m_randomKeyContainer = source.m_randomKeyContainer; 
        } 
        ...
        // flag that RSACryptoServiceProvider will take to mean that the key container name was randomly generated 
        private static uint randomKeyContainerFlag = 0xFFFFFFFF;
        private static uint RandomKeyContainerFlag 
        { 
            get
            { 
                if(randomKeyContainerFlag == 0xFFFFFFFF)
                {
                    FieldInfo keyContainerField = typeof(RSACryptoServiceProvider).GetField(
                        "RandomKeyContainerFlag", 
                        BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.DeclaredOnly);
 
                    if (keyContainerField != null) 
                        randomKeyContainerFlag = (uint)keyContainerField.GetValue(null);
                    else 
                        randomKeyContainerFlag = 0x00000000;
                }
                ...
                if (m_privateKey == null) { 
                    ...
                    case CAPI.CALG_RSA_SIGN: 
                        ...
                        { 
                            ...
                            permission.AccessEntries.Add(new KeyContainerPermissionAccessEntry(parameters, KeyContainerPermissionFlags.Open));
                            permission.Assert(); 

                            // Tell RSACryptoServiceProvider the key container was randomly generated
