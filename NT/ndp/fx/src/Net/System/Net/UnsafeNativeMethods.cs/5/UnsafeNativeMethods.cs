        ...
        internal unsafe class HttpApi {
            ...
            internal static class HTTP_REQUEST_HEADER_ID {
                ...
                static HTTP_REQUEST_HEADER_ID() {
                    ...
                    for (int i = 0; i<HttpHeaderRequestMaximum - 1; i++) {
            ...
            internal static class HTTP_RESPONSE_HEADER_ID { 
                ...
                static HTTP_RESPONSE_HEADER_ID() { 
                    ...
                    for (int i = 0; i < (int)Enum.HttpHeaderResponseMaximum - 1; i++) { 
                        m_Hashtable.Add(m_Strings[i], i);
                    }
                }
            ...
            static HttpApi() {
                SafeLoadLibrary module = SafeLoadLibrary.LoadLibraryEx(HTTPAPI); 
                if (module.IsInvalid) {
                    return; 
                } 
                try {
                    uint HTTP_INITIALIZE_SERVER = 1; 

                    HttpApi.HTTPAPI_VERSION HTTPAPI_VERSION_1 = new HttpApi.HTTPAPI_VERSION();
                    HTTPAPI_VERSION_1.HttpApiMajorVersion = 1;
                    HTTPAPI_VERSION_1.HttpApiMinorVersion = 0; 
                    GlobalLog.Print("HttpApi::.ctor() calling HttpApi.HttpInitialize()");
