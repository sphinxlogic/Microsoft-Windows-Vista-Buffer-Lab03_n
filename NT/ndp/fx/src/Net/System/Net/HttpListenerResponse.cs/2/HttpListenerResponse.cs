...
namespace System.Net { 
    ...
    public sealed unsafe class HttpListenerResponse : /* BaseHttpResponse, */ IDisposable {
        ...
        static readonly string[][] s_HTTPStatusDescriptions = new string[][] { 
            null,
        ...
        // unsafe class HttpListenerResponse : IDisposable { 
        ...
        public /* override */ string StatusDescription {
            get { 
                if (m_StatusDescription==null) {
                    ...
                    m_StatusDescription = GetStatusDescription((int)StatusCode); 
                }
                if (m_StatusDescription==null) { 
        ...
        public /* override */ void Redirect(string url) { 
            ...
            StatusDescription = GetStatusDescription((int)StatusCode); 
        }
        ...
        public void SetCookie(Cookie cookie) { 
            ...
            int added = Cookies.InternalAdd(cookie, true);
