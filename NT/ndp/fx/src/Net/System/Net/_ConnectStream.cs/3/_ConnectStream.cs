...
/* SSS_WARNINGS_OFF */                    GlobalLog.Print("ConnectStream#" + ValidationHelper.HashString(this) + "::InternalWrite() swallowing: size==0 || BufferOnly || IgnoreSocketErrors= " + (size==0) + BufferOnly + IgnoreSocketErrors); /* SSS_WARNINGS_ON */
                    if (async) { 
                    ...
                    try { 
                        ...
                        {
/* SSS_WARNINGS_OFF */                            GlobalLog.Print("ConnectStream#" + ValidationHelper.HashString(this) + "::InternalWrite() swallowing: IgnoreSocketErrors set after throw."); /* SSS_WARNINGS_ON */
                            if (async) 
                            {
                                completeSync = true; 
                            } 
                        ...
                        if (m_ErrorResponseStatus) { 
                            ...
                            // Note we could ignore this since receive callback is already posted and
