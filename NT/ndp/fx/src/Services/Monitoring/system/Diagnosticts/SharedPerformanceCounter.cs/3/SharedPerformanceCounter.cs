...
namespace System.Diagnostics { 
    ...
    internal sealed class SharedPerformanceCounter { 
        ...
        private unsafe int CreateCategory(CategoryEntry* lastCategoryPointer,
            ...
            Marshal.Copy(categoryName.ToCharArray(), 0, (IntPtr) nextPtr, categoryName.Length);
            ...
            Marshal.Copy(instanceName.ToCharArray(), 0, (IntPtr) nextPtr, instanceName.Length); 
            ...
            Marshal.Copy(counterName.ToCharArray(), 0, (IntPtr) nextPtr, counterName.Length);
        ...
        [ResourceExposure(ResourceScope.Machine)]  // Memory maps the perf counter data file
                    ...
                    if (hasFit) {
                        ...
                        if (sectionEntered) { 
                            try {
                                ...
                                char[] tmp = new char[instanceName.Length + 1]; 
                                instanceName.CopyTo(0, tmp, 0, instanceName.Length);
                                tmp[instanceName.Length] = '\0'; 
                                Marshal.Copy(tmp, 0, (IntPtr) instanceNamePtr, tmp.Length);
