        ...
        void ScanAttributes() { 
            ...
            while (BinXmlToken.EndAttrs != (token = NextToken())) { 
                if (BinXmlToken.Attr == token) {
                    ...
                    else if (Ref.Equals(n.namespaceUri, this.nsxmlns)) {
                ...
                switch (token) {
                    ...
                    case BinXmlToken.SQL_TEXT: 
                        ...
                        if (checkChars && this.checkCharacters) {
                            ...
                            XmlConvert.VerifyCharData(val, ExceptionType.XmlException);
        ...
        unsafe XmlNodeType CheckText(bool attr) { 
            ...
            fixed (byte* pb = this.data) {
                ...
                for (; ; ) { 
                    ...
                    if (ch < XmlConvert.SurHighStart || ch > XmlConvert.SurHighEnd) {
                        throw XmlConvert.CreateInvalidCharException(ch, ExceptionType.XmlException); 
                    }
                    else { 
                        if ((pos + 4) > end) { 
                        ...
                        if (chNext < XmlConvert.SurLowStart || chNext > XmlConvert.SurLowEnd) {
