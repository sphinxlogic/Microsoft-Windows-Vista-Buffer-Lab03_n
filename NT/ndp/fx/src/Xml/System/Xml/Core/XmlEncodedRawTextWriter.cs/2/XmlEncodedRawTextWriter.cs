...
//
        ...
        internal override void WriteXmlDeclaration( XmlStandalone standalone ) {
            ...
            if ( !omitXmlDeclaration && !autoXmlDeclaration ) {
                ...
                if ( encoding != null ) {
                    RawText( "\" encoding=\"" );
                    // Special-case big endian UTF-16 because System.Text output a wrong WebName. 
                    // (It uses "unicodeFFFE" instead of "UTF-16BE", which is not an IANA registered name fot this encoding).
