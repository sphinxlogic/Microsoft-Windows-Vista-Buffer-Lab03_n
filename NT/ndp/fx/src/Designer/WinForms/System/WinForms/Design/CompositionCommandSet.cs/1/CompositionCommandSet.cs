...
namespace System.Windows.Forms.Design {
    ...
    internal class CompositionCommandSet : CommandSet {
        ...
        private void RotateTabSelection(bool backwards) { 
            ...
            IComponent primarySelection = selSvc.PrimarySelection as IComponent;

            if (primarySelection != null) { 
                currentComponent = primarySelection;
            } 
            else { 
            ...
            if (currentControl != null) {
                ...
                for (int i = 1; i < compositionUI.Controls.Count; i++) {
                    if (compositionUI.Controls[i] == currentControl) { 
                        ...
                        ComponentTray.TrayControl tc = compositionUI.Controls[next] as ComponentTray.TrayControl; 
                        if (tc != null) {
                            nextControl = tc; 
                        } 
                        else {
                ...
                if (compositionUI.Controls.Count > 1) { 
                    Debug.Assert(compositionUI.Controls[0] is LinkLabel, "First item in the Composition designer is not a linklabel");
                    ComponentTray.TrayControl tc = compositionUI.Controls[1] as ComponentTray.TrayControl; 
                    if (tc != null) {
                        nextControl = tc;
                    }
                } 
