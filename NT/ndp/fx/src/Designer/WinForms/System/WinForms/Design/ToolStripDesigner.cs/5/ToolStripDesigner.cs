...
namespace System.Windows.Forms.Design 
{
    ...
    internal class ToolStripDesigner : ControlDesigner 
    {
        ...
        { 
            ...
            {
                Point loc = BehaviorService.ControlToAdornerWindow(ToolStrip); 
        ...
        private void OnUndone(object source, EventArgs e)
        {
            ...
            if (undoingCalled) 
            {
                ...
                // So that the Layout is proper after any user-transaction
        ...
        private void selSvc_SelectionChanged(object sender, EventArgs e) 
        {
            if (_miniToolStrip != null && host != null) 
            {
                ...
                { 
                    ...
                    // Select and make the control visible
                    // Cache in old value... 
                    currentVisible = Control.Visible && currentVisible;
