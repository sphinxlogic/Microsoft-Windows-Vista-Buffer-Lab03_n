...
namespace System.Windows.Forms.Design {
    ...
    public sealed class MenuCommands : StandardCommands { 
        ...
        /// <include file='doc\MenuCommands.uex' path='docs/doc[@for="MenuCommands.KeyShowDesignerShortcuts"]/*' />
        /// <devdoc>
        ///    <para>[To be supplied.]</para>
        /// </devdoc> 
        ...
        /// <include file='doc\MenuCommands.uex' path='docs/doc[@for="MenuCommands.EditLabel"]/*' /> 
        /// <devdoc>
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        public static readonly CommandID EditLabel       = new CommandID(VSStandardCommandSet97, cmdidEditLabel); 

        /// <include file='doc\MenuCommands.uex' path='docs/doc[@for="MenuCommands.KeyHome"]/*' /> 
        /// <devdoc> 
        ///    <para>[To be supplied.]</para>
        /// </devdoc> 
        public static readonly CommandID KeyHome  = new CommandID(guidVSStd2K, ECMD_HOME);

        /// <include file='doc\MenuCommands.uex' path='docs/doc[@for="MenuCommands.KeyEnd"]/*' />
        /// <devdoc> 
        ///    <para>[To be supplied.]</para>
        /// </devdoc> 
        ...
        /// <include file='doc\MenuCommands.uex' path='docs/doc[@for="MenuCommands.SetStatusText"]/*' />
        /// <devdoc> 
        ///    <para>[To be supplied.]</para>
        /// </devdoc> 
        public static readonly CommandID SetStatusText        = new CommandID(wfCommandSet, cmdidSetStatusText); 

        /// <include file='doc\MenuCommands.uex' path='docs/doc[@for="MenuCommands.SetStatusRectangle"]/*' /> 
        /// <devdoc>
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
