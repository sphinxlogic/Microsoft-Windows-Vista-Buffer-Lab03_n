//------------------------------------------------------------------------------ 
// <copyright file="DataGridViewColumnDesigner.cs" company="Microsoft">
...
namespace System.Windows.Forms.Design {
    ...
    /// <include file='doc\TableColumnDesigner.uex' path='docs/doc[@for="DataGridViewColumnDesigner"]/*' />
    /// <devdoc> 
            ...
            if (prop != null) { 
                if (this.Component.Site == null) {
                    ...
                    properties["Name"] = TypeDescriptor.CreateProperty(typeof(DataGridViewColumnDesigner),
                                         ...
                                         new DescriptionAttribute(SR.GetString(SR.DesignerPropName)), 
