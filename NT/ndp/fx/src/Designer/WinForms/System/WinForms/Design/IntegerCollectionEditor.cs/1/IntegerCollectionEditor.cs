    ...
    internal class IntegerCollectionEditor : CollectionEditor {
        ...
        private class IntegerCollectionForm : CollectionForm { 
            ...
            private void InitializeComponent() { 
                ...
                instruction.Text = SR.GetString(SR.IntegerCollectionEditorInstruction); 
                ...
                okButton.TabIndex = 1;
                okButton.Text = SR.GetString(SR.IntegerCollectionEditorOKCaption); 
                ...
                cancelButton.Text = SR.GetString(SR.IntegerCollectionEditorCancelCaption); 
                ...
                helpButton.Text = SR.GetString(SR.IntegerCollectionEditorHelpCaption); 
    #endif
 
                this.Location = new Point(7, 7);
                this.Text = SR.GetString(SR.IntegerCollectionEditorTitle);
