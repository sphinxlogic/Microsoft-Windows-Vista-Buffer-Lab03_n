//------------------------------------------------------------------------------ 
// <copyright file="ToolStripItemDesigner.cs" company="Microsoft">
...
{ 
    ...
    internal class ToolStripItemDesigner : ComponentDesigner
    {
        ...
        //
        // Used by the ParentDesigner (ToolStripDesigner) to know whether there
        // is any active Editor. 
        //
        ...
        //defaulted to invalid index.
        // this will be set by the behaviour.
        internal int indexOfItemUnderMouseToDrag = -1;
 

        // ToolStrip's Own Context Menu 
        //private BaseContextMenuStrip toolStripContextMenu; 
        ...
        internal bool AutoSize 
        {
            get 
            { 
                return (bool)ShadowProperties["AutoSize"];
            } 
            set
            {
                ...
                // it can come back to bite later after in-situ editing if we dont. 
        ...
        { 
            ...
            { 
                ...
                { 
                    ...
                    toolStripContextMenu.GroupOrdering.AddRange(new string[] { StandardGroups.Code, 
        ...
        /// <devdoc>
        ///      ToolStripEditorManager used this internal property to 
        ///      set the the desinger's IsEditorActive to notify
        ...
        /// <devdoc>
        ///      When the ToolStripItem is created we dont want InitializeNewComponent to set the "text" 
        ///      we do it ourselves from the Text the User has provided in the InSitu Edit Mode
        ...
        protected IComponent ImmediateParent
        {
            get 
            {
                ...
                { 
                    ...
                    return (parent != null) ? parent : ToolStripItem.Owner; 
                }
                return null;
            }
        } 
        ...
        private ToolStripItemOverflow Overflow 
        {
            get
            {
                return (ToolStripItemOverflow)ShadowProperties["Overflow"]; 
            }
            set 
            { 
                ...
                // Since this cause the whole Layout to Change ...
                // Call SyncSelection to reset the glyphs...
        ...
        protected override IComponent ParentComponent 
        {
            get 
            {
                if (ToolStripItem != null)
                {
                    ...
                    {
                        ToolStripDropDown parentDropDown = ImmediateParent as ToolStripDropDown; 
        ...
        public ToolStripItem ToolStripItem
        {
            get
            { 
                return (ToolStripItem)Component;
            } 
        } 
        ...
        /// <devdoc>
        ///     This method adds the Parent Hierarchy to arraylist and returns that arraylist to the Base ContextMenu provider. 
        ///     This way the ToolStripItem can show the right parents in the contextMenu 
        ///
        ///  <devdoc> 
                    ...
                    { 
                        ...
                        { 
                            ...
                            { 
                                ...
                                { 
                                    ToolStripDropDown parentDropDown = item.Owner as ToolStripDropDown;
                                    if (parentDropDown != null) 
                                    {
        ...
        /// <include file='doc\ToolStripItemDesigner.uex' path='docs/doc[@for="ToolStripItemDesigner.CreateDummyNode"]/*' /> 
        /// <devdoc>
        ...
        /// <include file='doc\ToolStripItemDesigner.uex' path='docs/doc[@for="ToolStripItemDesigner.CommitEdit"]/*' />
        /// <devdoc>
        ///      This is called by the TemplateNode to Commit the Edit.
        ///      This Function Simply changes the "Text and Image" property of the 
        ///      current ToolStripItem.
        /// </devdoc> 
        /// <internalonly/> 
        ...
        internal virtual void CommitEdit(Type type, string text, bool commit, bool enterKeyPressed, bool tabKeyPressed)
        {
            ...
            if (immediateParent is MenuStrip && type == typeof(ToolStripSeparator))
            {
                ...
                if (host != null) 
                {
                    ...
                    if (uiSvc != null) 
                    {
                        uiSvc.ShowError(SR.GetString(SR.ToolStripSeparatorError)); 
            ...
            { 
                ToolStripDropDownItem dropDown = newItem as ToolStripDropDownItem;
                if (dropDown != null) 
                {
        ...
        protected override void Dispose(bool disposing)
        {
 		...
 		/// <include file='doc\ToolStripItemDesigner.uex' path='docs/doc[@for="ToolStripItemDesigner.GetOwnerForActionList"]/*' />
        /// <devdoc> 
        ///      Returns the owner of the current ToolStripItem.
        /// </devdoc> 
        protected virtual Component GetOwnerForActionList() 
        {
            return (ToolStripItem.Placement == ToolStripItemPlacement.Main) ? ToolStripItem.GetCurrentParent() : ToolStripItem.Owner; 
        }
        ...
        private void FireComponentChanging(ToolStripDropDownItem parent) 
        {
            ...
            { 
            	...
            	{ 
            		...
            		if (dropDownItem != null && dropDownItem.DropDownItems.Count > 1 /*including TN*/) 
            		{
        ...
        /// <include file='doc\ToolStripItemDesigner.uex' path='docs/doc[@for="ToolStripItemDesigner.HideDummyNode"]/*' />
        /// <devdoc> 
        ///      This helper function resets the AutoSize property so that 
        ///      the item SNAPS back to its "preferredSize".
        /// </devdoc> 
        /// <internalonly/>
        ...
        /// <include file='doc\ToolStripItemDesigner.uex' path='docs/doc[@for="ToolStripItemDesigner.InitializeNewComponent"]/*' /> 
        /// <devdoc> 
        ...
        public override void InitializeNewComponent(IDictionary defaultValues)
        {
            ...
            // ComboBoxes and TextBoxes shouldnt have Texts...
            // In TextBoxBaseDesigner we do similar thing where we call the base (which sets the text) and then reset it back
        ...
        /// <include file='doc\ToolStripItemDesigner.uex' path='docs/doc[@for="ToolStripItemDesigner.MorphCurrentItem"]/*' />
        /// <devdoc> 
        ...
        { 
            ...
            //create our transaction
            DesignerTransaction designerTransaction = host.CreateTransaction(SR.GetString(SR.ToolStripMorphingItemTransaction)); 
            ...
            { 
                ...
                { 
                    ...
                    //Since destroying the original item took away its DropDownItems
                    // We need to Deserialize the items again... 
                    ...
                    // Add the Glyph for the DropDown ...
                    // We are responsible for the Glyh Addition since BodyGlyphs for DropDownItems are added by us. 
        ...
        /// <include file='doc\ToolStripItemDesigner.uex' path='docs/doc[@for="ToolStripItemDesigner.OnComponentRename"]/*' /> 
        /// <devdoc>
        ...
        /// <include file='doc\ToolStripItemDesigner.uex' path='docs/doc[@for="ToolStripItemDesigner.OnOverFlowDropDownPaint"]/*' />
        /// <devdoc> 
        ...
        { 
            ToolStripDropDown dropDown = ToolStripItem.GetCurrentParent() as ToolStripDropDown;
            if (dropDown != null)
            {
                if (selSvc != null) 
                {
        ...
        /// <include file='doc\ToolStripItemDesigner.uex' path='docs/doc[@for="ToolStripItemDesigner.OnSelectionChanged"]/*' /> 
        /// <devdoc>
        ...
        private void OnSelectionChanged(object sender, EventArgs e)
        {
            ...
            ISelectionService sSvc = sender as ISelectionService;
            ...
            ToolStripItem.ToolStripItemAccessibleObject acc = ToolStripItem.AccessibilityObject as ToolStripItem.ToolStripItemAccessibleObject;
            ...
            {
                if ((ToolStripItem != null) && (currentSelection.IsOnDropDown))
                {
                    if (ToolStripItem.Equals(currentSelection) && !(ToolStripItem is ToolStripMenuItem)) 
                    {
                        //If the Item is on DropDown ... Show its DropDown and all PArent Dropdown if not visible.. 
                        IDesignerHost designerHost = (IDesignerHost)GetService(typeof(IDesignerHost)); 
                        if (designerHost != null)
                        { 
                            ToolStripDropDown parentDropDown = currentSelection.Owner as ToolStripDropDown;
                            if (parentDropDown != null && !parentDropDown.Visible)
                            {
                                ToolStripDropDownItem parentItem = parentDropDown.OwnerItem as ToolStripDropDownItem; 
                                if (parentItem != null)
                                { 
        ...
        /// <include file='doc\ToolStripItemDesigner.uex' path='docs/doc[@for="ToolStripItemDesigner.PreFilterProperties"]/*' />
        /// <devdoc>
        ...
        { 
            ShadowProperties["AutoSize"] = false;
        }
        ...
        {
            ToolStripItem.AutoSize = (bool)ShadowProperties["AutoSize"]; 
        }
        ...
        { 
            ToolStripItem.Overflow = (ToolStripItemOverflow)ShadowProperties["Overflow"]; 
        }
        ...
        {
            ToolStripItem.Overflow = ToolStripItemOverflow.AsNeeded; 
        } 
        ...
        { 
            ShadowProperties["AccessibleName"] = null;
        } 
        ...
        {
            ToolStripItem.AccessibleName = (string)ShadowProperties["AccessibleName"]; 
        }
        ...
        { 
            return (ShadowProperties.Contains("AutoSize")); 
        }
        ...
        {
            return (ShadowProperties["AccessibleName"] != null); 
        } 
        ...
        { 
            return (ShadowProperties["Overflow"] != null);
        } 
 
        /// <include file='doc\ToolStripItemDesigner.uex' path='docs/doc[@for="ToolStripItemDesigner.ShowEditNode"]/*' />
        /// <devdoc> 
            ...
            { 
                ...
                if (parent != null) 
                {
                    ...
                    else
                    {
                        ...
                        { 
                            ToolStripDropDownItem ddItem = ToolStripItem as ToolStripDropDownItem; 
                            if (ddItem != null)
                            { 
                                ddItem.HideDropDown();
                            }
        ...
        // This method is called by the ToolStripDesigner to SetSelections to proper ToolStripItems
        // after the parent ToolStripItem is committed.
        // Consider this : 
        // the ToolStrip would cause the NEXT item on the TOPLEVEL to get selected...
        // while on MenuStrip.. we would want the Child ToolStripItem in the DropDown to get 
        // selected after the TopLevel MenuStripItem is commited. 
