...
namespace System.Web.UI.Design.WebControls.WebParts { 
    ...
    public class CatalogPartDesigner : PartDesigner {
        ...
        protected override Control CreateViewControl() {
            ...
            IDictionary state = ((IControlDesignerAccessor)_catalogPart).GetDesignModeState(); 
        ...
        public override void Initialize(IComponent component) { 
            VerifyInitializeArgument(component, typeof(CatalogPart));
            _catalogPart = (CatalogPart)component; 
