...
namespace System.Web.UI.Design.WebControls.ListControls { 
    ...
    internal sealed class DataGridPagingPage : BaseDataListPage {
        ...
        private void InitForm() { 
            ...
            this.AccessibleDescription = SR.GetString(SR.DGPg_Desc); 
        ...
        protected override void LoadComponent() { 
            ...
            pageSizeEdit.Text = (dataGrid.PageSize).ToString(NumberFormatInfo.CurrentInfo); 
            ...
            pageButtonCountEdit.Text = (pagerStyle.PageButtonCount).ToString(NumberFormatInfo.CurrentInfo);
        ...
        protected override void SaveComponent() {
            ...
            if (pageSizeText.Length != 0) {
                try {
                    dataGrid.PageSize = Int32.Parse(pageSizeText, CultureInfo.InvariantCulture);
                } 
                catch {
                    pageSizeEdit.Text = (dataGrid.PageSize).ToString(NumberFormatInfo.CurrentInfo); 
                } 
            ...
            if (pageButtonCountText.Length != 0) {
                try {
                    pagerStyle.PageButtonCount = Int32.Parse(pageButtonCountText, CultureInfo.InvariantCulture); 
                }
                catch { 
                    pageButtonCountEdit.Text = (pagerStyle.PageButtonCount).ToString(NumberFormatInfo.CurrentInfo); 
                }
        ...
        private void UpdateEnabledVisibleState() { 
            ...
            if (pageSize.Length != 0) {
                Int32.TryParse(pageSize, NumberStyles.Integer, CultureInfo.InvariantCulture, out pageSizeValue);
