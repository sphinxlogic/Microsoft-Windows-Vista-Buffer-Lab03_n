...
namespace System.Web.SessionState { 
    ...
    internal class StateApplication : IHttpHandler {
        ...
        unsafe IntPtr FinishPut(HttpContext context) { 
            ...
            if (entry != null) { 
                Debug.Assert(((int)SessionStateItemFlags.Uninitialized & extraFlags) == 0,
                    "((int)SessionStateItemFlags.Uninitialized & extraFlags) == 0; Cache shouldn't have the item when uninit flag is set");
