...
namespace System.Web.UI {
    ...
    internal sealed class CollectionBuilder : ControlBuilder {
        ...
        public override void Init(TemplateParser parser, ControlBuilder parentBuilder,
            ...
            propInfo = ControlType.GetProperty("Item", bindingFlags, null, null, new Type[] { typeof(int) }, null);
            if (propInfo == null) { 
                ...
                propInfo = ControlType.GetProperty("Item", bindingFlags); 
            }
            ...
            if (_itemType != null) { 
                ...
                if (!_itemType.IsAssignableFrom(childType)) {
                    ...
                    throw new HttpException(SR.GetString(
                        SR.Invalid_collection_item_type, new String[] { controlTypeName,
                                                                        _itemType.FullName, 
                                                                        tagName,
                                                                        childType.FullName})); 
                } 
        ...
        public override void AppendLiteralString(string s) { 
            ...
            if (!Util.IsWhiteSpaceString(s)) { 
                throw new HttpException(SR.GetString( 
                    SR.Literal_content_not_allowed, ControlType.FullName, s.Trim()));
            } 
        }
    }
