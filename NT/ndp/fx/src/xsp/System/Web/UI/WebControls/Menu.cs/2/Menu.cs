...
namespace System.Web.UI.WebControls { 
    ...
    public class Menu : HierarchicalDataBoundControl, IPostBackEventHandler, INamingContainer {
        ...
        internal void EnsureRenderSettings() {
            ...
            if (Page.SupportsStyleSheets || (Page.ScriptManager != null && Page.ScriptManager.IsInAsyncPostBack)) { 
                // Register the styles. NB the order here is important: later wins over earlier
                _panelStyle = Panel.GetEmptyPopOutPanelStyle();
                RegisterStyle(_panelStyle);
 
                RegisterStyle(RootMenuItemStyle);
 
                RegisterStyle(ControlStyle); 
                ...
                if (_staticItemStyle != null) {
                    ...
                    RegisterStyle(_staticItemStyle.HyperLinkStyle);
                    RegisterStyle(_staticItemStyle); 
                } 
                if (_staticMenuStyle != null) {
                    RegisterStyle(_staticMenuStyle); 
                }

                if (_dynamicItemStyle != null) {
                    _dynamicItemStyle.HyperLinkStyle.DoNotRenderDefaults = true; 
                    RegisterStyle(_dynamicItemStyle.HyperLinkStyle);
                    RegisterStyle(_dynamicItemStyle); 
                } 
                if (_dynamicMenuStyle != null) {
                    RegisterStyle(_dynamicMenuStyle); 
                }
                ...
                foreach (SubMenuStyle style in LevelSubMenuStyles) {
                    RegisterStyle(style); 
                }

                if (_staticSelectedStyle != null) {
                    _staticSelectedStyle.HyperLinkStyle.DoNotRenderDefaults = true; 
                    RegisterStyle(_staticSelectedStyle.HyperLinkStyle);
                    RegisterStyle(_staticSelectedStyle); 
                } 
                if (_dynamicSelectedStyle != null) {
                    _dynamicSelectedStyle.HyperLinkStyle.DoNotRenderDefaults = true; 
                    RegisterStyle(_dynamicSelectedStyle.HyperLinkStyle);
                    RegisterStyle(_dynamicSelectedStyle);
                }
                ...
                if (_staticHoverStyle != null) {
                    ...
                    RegisterStyle(_staticHoverHyperLinkStyle); 
                    RegisterStyle(_staticHoverStyle);
                } 
                if (_dynamicHoverStyle != null) { 
                    _dynamicHoverHyperLinkStyle = new HyperLinkStyle(_dynamicHoverStyle);
                    _dynamicHoverHyperLinkStyle.DoNotRenderDefaults = true; 
                    RegisterStyle(_dynamicHoverHyperLinkStyle);
                    RegisterStyle(_dynamicHoverStyle);
                }
            } 
        }
        ...
        protected override IDictionary GetDesignModeState() {
            ...
            using (StringWriter staticHtmlBuilder = new StringWriter(CultureInfo.CurrentCulture)) {
                using (HtmlTextWriter htmlWriter = GetDesignTimeWriter(staticHtmlBuilder)) { 
                    RenderBeginTag(htmlWriter);
                    RenderContents(htmlWriter, true); 
                    RenderEndTag(htmlWriter, true); 
        ...
        protected override bool OnBubbleEvent(object source, EventArgs e) {
            ...
            if (me != null && StringUtil.EqualsIgnoreCase(me.CommandName, MenuItemClickCommandName)) { 
                ...
                OnMenuItemClick(me);
                if(_adapter != null) { 
                    MenuAdapter menuAdapter = _adapter as MenuAdapter;
                    if (menuAdapter != null) { 
                        MenuItem mi = me.Item; 
        ...
        internal void OnPreRender(EventArgs e, bool registerScript) {
            ...
            if (Page != null && registerScript) {
                ...
                Page.ClientScript.RegisterClientScriptResource(this, typeof(Menu), "Menu.js");
                ...
                createDataObjectScript.Append(DynamicHorizontalOffset);
                createDataObjectScript.Append(";\r\n"); 
                createDataObjectScript.Append(clientDataObjectID);
                createDataObjectScript.Append(".verticalOffset = ");
                createDataObjectScript.Append(DynamicVerticalOffset);
                createDataObjectScript.Append(";\r\n"); 
                if (_dynamicHoverStyle != null) {
                    createDataObjectScript.Append(clientDataObjectID); 
                    createDataObjectScript.Append(".hoverClass = '"); 
                    createDataObjectScript.Append(_dynamicHoverStyle.RegisteredCssClass);
                    if (!String.IsNullOrEmpty(_dynamicHoverStyle.CssClass)) { 
                        if (!String.IsNullOrEmpty(_dynamicHoverStyle.RegisteredCssClass)) {
                            createDataObjectScript.Append(' ');
                        }
                        createDataObjectScript.Append(_dynamicHoverStyle.CssClass); 
                    }
                    createDataObjectScript.Append("';\r\n"); 
                    if (_dynamicHoverHyperLinkStyle != null) { 
                        createDataObjectScript.Append(clientDataObjectID);
                        createDataObjectScript.Append(".hoverHyperLinkClass = '"); 
                        createDataObjectScript.Append(_dynamicHoverHyperLinkStyle.RegisteredCssClass);
                        if (!String.IsNullOrEmpty(_dynamicHoverStyle.CssClass)) {
                            if (!String.IsNullOrEmpty(_dynamicHoverHyperLinkStyle.RegisteredCssClass)) {
                                createDataObjectScript.Append(' '); 
                            }
                            createDataObjectScript.Append(_dynamicHoverStyle.CssClass); 
                        } 
                ...
                if (_staticHoverStyle != null && _staticHoverHyperLinkStyle != null) {
                    createDataObjectScript.Append(clientDataObjectID);
                    createDataObjectScript.Append(".staticHoverClass = '"); 
                    createDataObjectScript.Append(_staticHoverStyle.RegisteredCssClass);
                    if (!String.IsNullOrEmpty(_staticHoverStyle.CssClass)) { 
                        if (!String.IsNullOrEmpty(_staticHoverStyle.RegisteredCssClass)) { 
                            createDataObjectScript.Append(' ');
                        } 
                        createDataObjectScript.Append(_staticHoverStyle.CssClass);
                    }
                    createDataObjectScript.Append("';\r\n");
                    if (_staticHoverHyperLinkStyle != null) { 
                        createDataObjectScript.Append(clientDataObjectID);
                        createDataObjectScript.Append(".staticHoverHyperLinkClass = '"); 
                        createDataObjectScript.Append(_staticHoverHyperLinkStyle.RegisteredCssClass); 
                        if (!String.IsNullOrEmpty(_staticHoverStyle.CssClass)) {
                            if (!String.IsNullOrEmpty(_staticHoverHyperLinkStyle.RegisteredCssClass)) { 
                               createDataObjectScript.Append(' ');
                            }
                            createDataObjectScript.Append(_staticHoverStyle.CssClass);
                        } 
                ...
                if ((Page.RequestInternal != null) &&
                    (String.Equals(Page.Request.Url.Scheme, "https", StringComparison.OrdinalIgnoreCase))) { 
        ...
        protected internal override void Render(HtmlTextWriter writer) {
            ...
            if (Items.Count > 0) { 
                ...
                RenderContents(writer, false);
                RenderEndTag(writer, false); 
            }
        }
        ...
        public override void RenderBeginTag(HtmlTextWriter writer) { 
            ...
            SubMenuStyle rootMenuStyle = GetSubMenuStyle(RootItem); 
            if (Page != null && Page.SupportsStyleSheets) {
                string styleClass = GetSubMenuCssClassName(RootItem);
            ...
            if (StaticDisplayLevels > 1) { 
                if (Orientation == Orientation.Vertical) {
                    ...
                    for (int i = 0; i < Items.Count; i++) {
                        Items[i].RenderItem(writer, i, enabled, Orientation, staticOnly); 
        ...
        private void RenderEndTag(HtmlTextWriter writer, bool staticOnly) { 
            ...
            // Render the submenus
            if (StaticDisplayLevels <= 1 && !staticOnly) {
                bool enabled = IsEnabled; 
                for (int i = 0; i < Items.Count; i++) {
                    Items[i].Render(writer, enabled, staticOnly); 
                } 
