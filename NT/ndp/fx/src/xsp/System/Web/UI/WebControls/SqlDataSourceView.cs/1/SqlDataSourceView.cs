...
namespace System.Web.UI.WebControls { 
    ...
    public class SqlDataSourceView : DataSourceView, IStateManager { 
        ...
        private void AddParameters(DbCommand command, ParameterCollection reference, IDictionary parameters, IDictionary exclusionList, string oldValuesParameterFormatString) { 
            ...
            if (parameters != null) { 
                ...
                foreach (DictionaryEntry de in parameters) {
                    ...
                    if (parameter != null) {
                        value = Parameter.GetValue(de.Value, parameter.DefaultValue, parameter.Type, parameter.ConvertEmptyStringToNull, false);
                    }
        ...
        /// </devdoc>
        private static DbType ConvertTypeCodeToDbType(TypeCode typeCode) { 
            switch (typeCode) {
                ...
                case TypeCode.Empty: 
                    Debug.Fail("ConvertTypeCodeToDbType should never be called with TypeCode.DBNull or TypeCode.Empty.");
                    return DbType.Object;
            }
        } 
        ...
        protected override int ExecuteDelete(IDictionary keys, IDictionary oldValues) {
            ...
            IDictionary deleteParameters = DeleteParameters.GetValues(_context, _owner); 
            AddParameters(command, DeleteParameters, deleteParameters, oldValues, null); 
            ...
            for (int i = 0; i < parameters.Count; i++) {
                ...
                if ((caseInsensitiveExclusionList == null) || (!caseInsensitiveExclusionList.Contains(parameter.Name))) { 
                    ...
                    if (parameter.Type != TypeCode.Empty && parameter.Type != TypeCode.DBNull) {
                        dbParameter.DbType = ConvertTypeCodeToDbType(parameter.Type); 
                    }
                    command.Parameters.Add(dbParameter);
                }
            } 
