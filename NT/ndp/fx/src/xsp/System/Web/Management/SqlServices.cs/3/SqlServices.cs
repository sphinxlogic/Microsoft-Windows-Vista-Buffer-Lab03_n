...
#if SITECOUNTERS 
            new FeatureInfo(SqlFeatures.SiteCounters,
                            new string[] {INSTALL_COMMON_SQL, "InstallSiteCounters.sql"}, 
                            new string[] {"UninstallSiteCounters.sql"}, 
                            new string[] {"aspnet_SiteCounters"},
                            32), 
#endif
