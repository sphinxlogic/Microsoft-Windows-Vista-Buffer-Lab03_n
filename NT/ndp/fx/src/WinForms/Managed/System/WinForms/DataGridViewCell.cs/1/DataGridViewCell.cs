...
namespace System.Windows.Forms
{
    ...
    { 
        ...
        public Rectangle GetContentBounds(int rowIndex) 
        {
            ...
            return GetContentBounds(this.DataGridView.CachedGraphics, dataGridViewCellStyle, rowIndex);
        } 
        ...
        internal Rectangle GetErrorIconBounds(int rowIndex)
        {
            Debug.Assert(this.DataGridView != null);
            DataGridViewCellStyle dataGridViewCellStyle = GetInheritedStyle(null, rowIndex, false /*includeColors*/); 
            return GetErrorIconBounds(this.DataGridView.CachedGraphics, dataGridViewCellStyle, rowIndex);
        } 
        ...
        { 
            ...
            DataGridViewCellStyle dataGridViewCellStyle = GetInheritedStyle(null, rowIndex, false); 
            return GetPreferredSize(this.DataGridView.CachedGraphics, dataGridViewCellStyle, rowIndex, new Size(width, 0)).Height; 
        }
        ...
        internal Size GetPreferredSize(int rowIndex)
        {
            ...
            DataGridViewCellStyle dataGridViewCellStyle = GetInheritedStyle(null, rowIndex, false); 
            return GetPreferredSize(this.DataGridView.CachedGraphics, dataGridViewCellStyle, rowIndex, Size.Empty);
        } 
        ...
        { 
            ...
            DataGridViewCellStyle dataGridViewCellStyle = GetInheritedStyle(null, rowIndex, false);
            return GetPreferredSize(this.DataGridView.CachedGraphics, dataGridViewCellStyle, rowIndex, new Size(0, height)).Width; 
        }
            ...
            { 
                if (this.FormattedValueType == stringType)
                {
                             ...
                             rowIndex == -1) 
                    {
                        ...
                        {
                            DataGridViewCellStyle dataGridViewCellStyle = GetInheritedStyle(null, rowIndex, false);
                            Rectangle contentBounds = GetContentBounds(this.DataGridView.CachedGraphics, dataGridViewCellStyle, rowIndex);
                            bool widthTruncated = false; 
                            int preferredHeight = 0;
                            if (contentBounds.Width > 0) 
                            { 
                                preferredHeight = DataGridViewCell.GetPreferredTextHeight(this.DataGridView.CachedGraphics,
