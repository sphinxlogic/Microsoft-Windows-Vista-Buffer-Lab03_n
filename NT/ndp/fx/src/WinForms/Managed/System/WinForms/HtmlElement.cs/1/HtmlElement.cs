...
namespace System.Windows.Forms 
{
    ...
    public sealed class HtmlElement 
    {
        ...
        public HtmlElement FirstChild
        {
            get 
            {
                return new HtmlElement(shimManager, (UnsafeNativeMethods.IHTMLElement)((UnsafeNativeMethods.IHTMLDOMNode)this.NativeHtmlElement).FirstChild()); 
            } 
        }
        ...
        { 
            get
            { 
                return new HtmlElement(shimManager, (UnsafeNativeMethods.IHTMLElement)((UnsafeNativeMethods.IHTMLDOMNode)this.NativeHtmlElement).NextSibling()); 
            }
        } 
