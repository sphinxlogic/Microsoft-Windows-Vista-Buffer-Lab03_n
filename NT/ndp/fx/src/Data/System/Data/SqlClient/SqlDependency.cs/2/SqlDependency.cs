...
namespace System.Data.SqlClient { 
    ...
    sealed class SqlDependency { 
        ...
        private string ComputeFullString(SqlCommand command) {
            IntPtr hscp; 
            Bid.NotificationsScopeEnter(out hscp, "<sc.SqlDependency.ComputeFullString|DEP> %d#, SqlCommand: %d#", ObjectID, command.ObjectID); 
            try {
                // Create a string representing the concatenation of the command text and .ToString on all parameter values. 
                ...
                Bid.NotificationsTrace("<sc.SqlDependency.ComputeFullString|DEP> ComputeFullString result: '%ls'.\n", result); 
                return result;
            }
            finally {
                Bid.ScopeLeave(ref hscp); 
