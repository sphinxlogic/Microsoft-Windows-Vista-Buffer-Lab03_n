        ...
        static internal SqlMetaData GetNewSqlMetaDataFromOld(_SqlMetaData sqlMetaData, string name) {
            ...
            if(sqlMetaData.metaType.SqlDbType == SqlDbType.Udt) {
                ...
                smdt = new SqlMetaData(
                    name,
                    sqlMetaData.metaType.SqlDbType,
                    maxlen, 
                    precision,
                    scale, 
                    lcid, 
                    compEnum,
                    sqlMetaData.xmlSchemaCollectionDatabase, 
                    sqlMetaData.xmlSchemaCollectionOwningSchema,
                    sqlMetaData.xmlSchemaCollectionName,
                    sqlMetaData.metaType.IsPlp,
                    null); 
            }
