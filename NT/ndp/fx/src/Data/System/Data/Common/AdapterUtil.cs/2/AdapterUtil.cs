...
namespace System.Data.Common {
    ...
    internal static class ADP { 
        ...
        static internal ArgumentOutOfRangeException InvalidUserDefinedTypeSerializationFormat(Microsoft.SqlServer.Server.Format value) {
            ...
            case Microsoft.SqlServer.Server.Format.Structured:
#endif 
...
//          UnexpectedTransactedObject                              = 11,
        ...
        static internal Int32 GetCurrentThreadId() {
...
#pragma warning restore 618
        ...
        static internal string GetComputerNameDnsFullyQualified() {
            ...
            int length = 256; // environment.cs, MAX_COMPUTERNAME_LENGTH 

            string value; 
            if (IsPlatformNT5) {
                SafeNativeMethods.GetComputerNameEx(ComputerNameDnsFullyQualified, null, ref length);
...
// 
        ...
        static internal bool IsNull(object value, out bool isINullable) { 
            INullable nullable = (value as INullable);
            isINullable = (null != nullable); 
            return ((isINullable && nullable.IsNull) || (null == value) || (DBNull.Value == value));
        }
    }
} 
