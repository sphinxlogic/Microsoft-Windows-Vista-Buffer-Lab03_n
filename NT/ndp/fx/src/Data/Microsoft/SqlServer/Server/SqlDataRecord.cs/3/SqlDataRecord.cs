...
#if WINFS_UTC 
        public virtual SqlUtcDateTime GetSqlUtcDateTime(int ordinal) {
            return ValueUtilsSmi.GetSqlUtcDateTime( _eventSink, _recordBuffer, ordinal, GetSmiMetaData( ordinal ) );
        }
 
        public virtual SqlDate GetSqlDate(int ordinal) {
            return ValueUtilsSmi.GetSqlDate( _eventSink, _recordBuffer, ordinal, GetSmiMetaData( ordinal ) ); 
        } 

        public virtual SqlTime GetSqlTime(int ordinal) { 
            return ValueUtilsSmi.GetSqlTime( _eventSink, _recordBuffer, ordinal, GetSmiMetaData( ordinal ) );
        }
#endif
