...
[System.Runtime.InteropServices.ComVisible(true)]
    public sealed class CryptoAPITransform : ICryptoTransform {
        ...
        internal CryptoAPITransform(int algid, int cArgs, int[] rgArgIds, 
            ...
            _safeProvHandle = Utils.AcquireProvHandle(new CspParameters(Constants.PROV_RSA_FULL)); 
            ...
            for (int i=0; i<cArgs; i++) { 
                ...
                case Constants.KP_IV: 
                    ...
                    rgbValue = IVValue;
                    Utils._SetKeyParamRgb(_safeKeyHandle, _rgArgIds[i], rgbValue);
                    break; 
                ...
                SetAsDWord: 
                    Utils._SetKeyParamDw(_safeKeyHandle, _rgArgIds[i], dwValue);
                    break;
        ...
        private void Dispose(bool disposing) {
            if (disposing) {
                // we always want to clear out these items clear out _rgbKey
                if (_rgbKey != null) { 
...
[System.Runtime.InteropServices.ComVisible(true)]
    public sealed class CspParameters { 
        ...
        public CspProviderFlags Flags { 
            ...
            set { 
                uint allFlags = 0x8000007F; // this should change if more values are added to CspProviderFlags
        ...
        public CspParameters () : this(Constants.PROV_RSA_FULL, null, null) {} 
