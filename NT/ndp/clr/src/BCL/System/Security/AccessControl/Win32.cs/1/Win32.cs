...
namespace System.Security.AccessControl
{
    internal static class Win32 
    {
        ...
        {
            //
            // SDDL-to-binary conversion only supported on W2K, XP and above 
            //
            ...
            {
                BCLDebug.Assert( false, "OSVersion native call failed" );
            ...
            GenericAcl dacl )
        {
            ...
            { 
                ...
                { 
                    // both are null, shouldn't happen
                    BCLDebug.Assert( false, "Internal error: both name and handle are null" ); 
