    ...
    public sealed class ResourceReader : IResourceReader 
    {
        ...
        private void InitSafeToDeserializeArray() 
        {
            ...
            for(int i=0; i<_typeTable.Length; i++) { 
                ...
                AssemblyName an; 
                String typePart;
                Type resourceType = Type.GetType(typeName, false);
                if (resourceType == null) {
                    ...
                    an = new AssemblyName(); 
                    Assembly a = resourceType.Assembly;
                    an.Init(a.nGetSimpleName(),
                            a.nGetPublicKey(),
        ...
        internal sealed class TypeLimitingDeserializationBinder : SerializationBinder
        {
            ...
            { 
                ...
                Assembly a = _typeToDeserialize.Assembly;
                an.Init(a.nGetSimpleName(), 
                        a.nGetPublicKey(),
                        null, // public key token
                        null, // version
                ...
                // got a hacked .resources file on your hands, or WinForms
