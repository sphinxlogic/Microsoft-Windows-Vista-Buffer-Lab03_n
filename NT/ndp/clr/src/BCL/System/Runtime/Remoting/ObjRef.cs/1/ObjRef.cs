...
[System.Runtime.InteropServices.ComVisible(true)] 
	...
	public virtual void GetObjectData(SerializationInfo info, StreamingContext context) 
	{
        ...
        { 
            ...
            //   we should only bash the url if the ObjRef is from the current appdomain.</STRIP>
        ...
        { 
            ...
            { 
                ...
                if (o is AppDomain){
                    ...
                    // Clone the data so that we dont bash the current appdomain data which is stored 
                    // as a static
