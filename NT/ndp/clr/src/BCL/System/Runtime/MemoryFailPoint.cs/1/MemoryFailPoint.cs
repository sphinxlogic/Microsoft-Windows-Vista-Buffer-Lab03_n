    ...
    { 
        ...
        public MemoryFailPoint(int sizeInMegabytes)
        {
            ...
            for(int stage = 0; stage < 3; stage++) { 
                ...
                // Note that multiple threads can still race on our free chunk
                ...
                default: 
                    BCLDebug.Assert(false, "Fell through switch statement!");
                    break; 
                } 
            }
            ...
            // and handle a simple race with other MemoryFailPoint instances.
        ...
        private static void CheckForAvailableMemory(out ulong availPageFile, out ulong totalAddressSpaceFree)
        {
            ...
            if (Environment.IsWin9X()) {
                Win32Native.MEMORYSTATUS memory = new Win32Native.MEMORYSTATUS(); 
                r = Win32Native.GlobalMemoryStatus(memory); 
                if (!r)
                    __Error.WinIOError(); 
