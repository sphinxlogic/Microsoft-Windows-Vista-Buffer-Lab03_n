            ...
            else
            {
                ...
                { 
                    ...
                    { 
                        ...
                        if (!(BinaryConverter.IsTypePrimitive(argTypes[i]) || argTypes[i] == Converter.typeofString) || args[i] is ISerializable)
                        {
        ...
        internal Object[] WriteArray(Object returnValue, Object[] args, Exception exception, Object callContext, Object[] properties)
        {
            ...
            { 
                ...
                { 
                    ...
                    { 
                        argTypes[i] = args[i].GetType(); 
                        if (!(BinaryConverter.IsTypePrimitive(argTypes[i]) || argTypes[i] == Converter.typeofString))
                        { 
                            bArgsPrimitive = false;
                            break;
                        }
            ...
            { 
                ...
                if (BinaryConverter.IsTypePrimitive(returnType) || returnType == Converter.typeofString) 
