    ...
    { 
            ...
            ImageFileMachine imageFileMachine) 
        {
            ...
            if (m_moduleData.m_strResourceFileName != null) 
                InternalDefineNativeResourceFile(m_moduleData.m_strResourceFileName, (int)portableExecutableKind, (int)imageFileMachine);
            else
            if(m_moduleData.m_resourceBytes != null)
                InternalDefineNativeResourceBytes(m_moduleData.m_resourceBytes, (int)portableExecutableKind, (int)imageFileMachine); 
#endif // !FEATURE_PAL
        ...
        internal MethodToken InternalGetConstructorToken(ConstructorInfo con, bool usingRef) 
        {
            ...
            { 
                ...
                if (usingRef == false && conBuilder.ReflectedType.Module.InternalModule.Equals(this.InternalModule)) 
...
[System.Runtime.InteropServices.ComVisible(true)]
        ...
        private TypeToken GetTypeTokenNoLock(Type type)
        {
            ...
            return GetTypeTokenWorkerNoLock(type);
        }
        ...
        private TypeToken GetTypeTokenWorkerNoLock(Type type)
        {
            CheckContext(type);
        ...
        private MethodToken GetMethodTokenNoLock(MethodInfo method, bool legacy) 
        { 
            ...
            { 
                ...
                tr = legacy ? GetTypeToken(method.DeclaringType).Token : GetTypeTokenInternal(method.DeclaringType).Token;
