...
#region Serialization
        ...
        public virtual String EnglishName 
        {
            get 
            {
/* SSS_WARNINGS_OFF */                return (this.m_cultureTableRecord.SENGCOUNTRY); /* SSS_WARNINGS_ON */
            }
        } 
        ...
        public virtual String DisplayName 
        {
            get 
            {
                if (m_cultureTableRecord.IsCustomCulture)
                {
                    ...
                    { 
/* SSS_WARNINGS_OFF */                        return this.m_cultureTableRecord.SNATIVECOUNTRY; /* SSS_WARNINGS_ON */
                    } 
                } 
                else
                { 
