...
#pragma warning restore 169
        ...
        private void SetDomainManager (Evidence providedSecurityInfo, Evidence creatorsSecurityInfo, IntPtr parentSecurityDescriptor, bool publishAppDomain) {
#if !FEATURE_PAL 
            BCLDebug.Assert(_domainManager == null, "The domain manager should be set only once for a given AppDomain."); 
#endif //!FEATURE_PAL
            ...
            if (adSetup.ActivationArguments != null) {
                ...
                if (appTrust != null) 
                    SetupDomainSecurityForApplication(appTrust.ApplicationIdentity, appTrust);
            } 
#endif //!FEATURE_PAL 
